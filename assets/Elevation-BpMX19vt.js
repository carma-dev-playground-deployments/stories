...
`}function XE(e){return e===1?"float":`vec${e}`}function $E(e){return e===1?".x":e===2?".xy":e===3?".xyz":""}function ZE(e,t){const o=e._attributes[t],i=o.componentsPerAttribute,a=o.functionName,r=XE(i),s=$E(i),c=e._offsets[t];let l=`${r} ${a}(float batchId) 
{ 
...
void main()
{
    vec4 p = czm_computePosition();
    gl_Position = czm_modelViewProjectionRelativeToEye * p;
}`,ir=e=>Number.isFinite(e)?e.toFixed(6):"0.0",Vs=e=>`vec4(${ir(e.red)}, ${ir(e.green)}, ${ir(e.blue)}, ${ir(e.alpha)})`,QA=e=>`
in vec2 v_st;
...
}`,eO=(e,t)=>new Hn({translucent:!0,closed:!1,renderState:Mh,vertexShaderSource:ZA,fragmentShaderSource:e===zo.CHROME_MIRROR?QA(t):JA(t)}),tO=e=>`
void main()
{
    out_FragColor = ${Vs(e)};
}`,nO=e=>new Hn({translucent:e.alpha<1,closed:!1,renderState:Mh,vertexShaderSource:KA,fragmentShaderSource:tO(e)}),oO=({id:e,geometry:t,color:n,opacity:o,materialPreset:i,modelMatrix:a,asynchronous:r=!0})=>{const s=O.fromAlpha(n,o,new O);return i===zo.COLOR?new Ue({geometryInstances:new Ya({id:`${e}-fill`,geometry:t}),appearance:nO(s),allowPicking:!1,asynchronous:r,releaseGeometryInstances:!0,show:!0,modelMatrix:a}):new Ue({geometryInstances:new Ya({id:`${e}-fill`,geometry:t}),appearance:eO(i,s),allowPicking:!1,asynchronous:r,releaseGeometryInstances:!0,show:!0,modelMatrix:a})},iO=e=>{const t=UA(e.radius),n=GA(e.innerRadius,t),o=Dh(e.segments),i=Nh(e.angleRad),a=Lh(o,i),r=kA(e.rotationRad),s=e.modelMatrix??M.IDENTITY,c=jA(e.materialPreset),l=e.color??zh,d=VA(e.opacity,l.alpha??LA),m=rO(f.ZERO,t,r);return{normalizedInnerRadius:qA(n,t),arcSampling:a,color:l,opacity:d,materialPreset:c,vertexFormat:c===zo.COLOR?Ph:BA,modelMatrix:M.multiply(s,m,new M)}},rO=(e,t=1,n=0)=>DA(e,t,n,Ih),aO=(e,t)=>{const n=iO(t),o=$A({innerRadiusRatio:n.normalizedInnerRadius,angleRad:t.angleRad,segments:n.arcSampling.segments,vertexFormat:n.vertexFormat});return oO({id:e,geometry:o,color:n.color,opacity:n.opacity,materialPreset:n.materialPreset,modelMatrix:n.modelMatrix,asynchronous:t.asynchronous})},sO=(e,t)=>aO(e,{...t,angleRad:kn,rotationRad:0}),vO=(e,t)=>sO(e,{...t,innerRadius:0});Gh("[CESIUM|ELEVATION] Using core elevation helpers from @carma-mapping/engines/cesium/core.");export{wO as $,dm as A,Q as B,f as C,T as D,Vf as E,ue as F,Ya as G,ns as H,Xe as I,ae as J,Oe as K,pO as L,M,Mt as N,Ee as O,Ue as P,K as Q,zo as R,wA as S,_e as T,yO as U,_O as V,gO as W,kh as X,bO as Y,id as Z,EO as _,A as a,z as a$,TO as a0,os as a1,qe as a2,xO as a3,SO as a4,Qa as a5,CO as a6,dn as a7,Oi as a8,ye as a9,ss as aA,Ma as aB,me as aC,Ls as aD,At as aE,nn as aF,ht as aG,Kt as aH,en as aI,tt as aJ,Me as aK,Pt as aL,Hn as aM,Be as aN,mt as aO,FE as aP,Us as aQ,Jt as aR,ln as aS,So as aT,St as aU,L1 as aV,F1 as aW,ii as aX,gi as aY,It as aZ,Ot as a_,Ar as aa,Ae as ab,oe as ac,De as ad,Se as ae,Re as af,zn as ag,Ai as ah,J as ai,Ce as aj,ro as ak,oo as al,Et as am,Lt as an,to as ao,Te as ap,Tt as aq,xe as ar,Ge as as,zt as at,Ve as au,Bo as av,ni as aw,Fe as ax,re as ay,nt as az,ne as b,ge as b0,Rl as b1,he as b2,pn as b3,Le as b4,Ye as b5,Mo as b6,Ze as b7,Vt as b8,eo as b9,An as ba,dt as bb,so as bc,In as bd,jt as be,jf as bf,wt as bg,Cn as bh,we as bi,cu as bj,Qf as bk,li as bl,rc as bm,ui as bn,vr as bo,mn as bp,st as bq,wo as br,Gt as bs,jh as bt,O as c,vO as d,sO as e,aO as f,$A as g,DA as h,AO as i,u as j,U as k,qh as l,OO as m,on as n,X as o,Sn as p,P as q,j as r,le as s,Ti as t,h as u,et as v,qo as w,We as x,ee as y,yr as z};
