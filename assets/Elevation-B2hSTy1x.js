 ...
 *
 */var ll;function uw(){return ll||(ll=1,function(e){(function(t,n){e.exports?e.exports=n():t.IPv6=n(t)})(Xn,function(t){var n=t&&t.IPv6;function o(r){var a=r.toLowerCase(),s=a.split(":"),c=s.length,f=8;s[0]===""&&s[1]===""&&s[2]===""?(s.shift(),s.shift()):s[0]===""&&s[1]===""?s.shift():s[c-1]===""&&s[c-2]===""&&s.pop(),c=s.length,s[c-1].indexOf(".")!==-1&&(f=7);var d;for(d=0;d<c&&s[d]!=="";d++);if(d<f)for(s.splice(d,1,"0000");s.length<f;)s.splice(d,0,"0000");for(var u,m=0;m<f;m++){u=s[m].split("");for(var _=0;_<3&&(u[0]==="0"&&u.length>1);_++)u.splice(0,1);s[m]=u.join("")}var g=-1,y=0,E=0,A=-1,S=!1;for(m=0;m<f;m++)S?s[m]==="0"?E+=1:(S=!1,E>y&&(g=A,y=E)):s[m]==="0"&&(S=!0,A=m,E=1);E>y&&(g=A,y=E),y>1&&s.splice(g,y,""),c=s.length;var O="";for(s[0]===""&&(O=":"),m=0;m<c&&(O+=s[m],m!==c-1);m++)O+=":";return s[c-1]===""&&(O+=":"),O}function i(){return t.IPv6===this&&(t.IPv6=n),this}return{best:o,noConflict:i}})}(Ws)),Ws.exports}var Ys={exports:{}};/*!
 * URI.js - Mutating URLs
...
`,yO=`struct czm_shadowParameters
{
...
`,FO=`float getSignedDistance(vec2 uv, highp sampler2D clippingDistance) {
...
`,vC=`vec3 lambertianDiffuse(vec3 diffuseColor)
{
...
`,TC=`// KhronosGroup https://github.com/KhronosGroup/ToneMapping/tree/main/PBR_Neutral
...
`,SC=`float czm_private_getLambertDiffuseOfMaterial(vec3 lightDirectionEC, czm_material material)
{
...
`,MC=`float czm_readDepth(sampler2D depthTexture, vec2 texCoords)
{
...
`,PC=`float czm_reverseLogDepth(float logZ)
{
#ifdef LOG_DEPTH
...
`,HC=`vec2 getLookupUv(vec2 dimensions, int i) {
...
`,KC=`vec4 czm_screenToEyeCoordinates(vec4 screenCoordinate)
{
...
`,Oc={czm_degreesPerRadian:xx,czm_depthRange:Ox,czm_epsilon1:Cx,czm_epsilon2:Mx,czm_epsilon3:Rx,czm_epsilon4:Px,czm_epsilon5:Ix,czm_epsilon6:zx,czm_epsilon7:Nx,czm_infinity:Dx,czm_oneOverPi:Lx,czm_oneOverTwoPi:Fx,czm_passCesium3DTile:Bx,czm_passCesium3DTileClassification:Ux,czm_passCesium3DTileClassificationIgnoreShow:Gx,czm_passClassification:qx,czm_passCompute:kx,czm_passEnvironment:jx,czm_passGaussianSplats:Vx,czm_passGlobe:Hx,czm_passOpaque:Wx,czm_passOverlay:Yx,czm_passTerrainClassification:$x,czm_passTranslucent:Xx,czm_passVoxels:Zx,czm_pi:Kx,czm_piOverFour:Qx,czm_piOverSix:Jx,czm_piOverThree:eO,czm_piOverTwo:tO,czm_radiansPerDegree:nO,czm_sceneMode2D:oO,czm_sceneMode3D:iO,czm_sceneModeColumbusView:rO,czm_sceneModeMorphing:aO,czm_solarRadius:sO,czm_threePiOver2:cO,czm_twoPi:fO,czm_webMercatorMaxLatitude:hO,czm_depthRangeStruct:lO,czm_material:uO,czm_materialInput:dO,czm_modelMaterial:mO,czm_modelVertexOutput:pO,czm_ray:_O,czm_raySegment:gO,czm_shadowParameters:yO,czm_HSBToRGB:bO,czm_HSLToRGB:EO,czm_RGBToHSB:wO,czm_RGBToHSL:vO,czm_RGBToXYZ:TO,czm_XYZToRGB:SO,czm_acesTonemapping:AO,czm_alphaWeight:xO,czm_antialias:OO,czm_applyHSBShift:CO,czm_approximateSphericalCoordinates:MO,czm_approximateTanh:RO,czm_backFacing:PO,czm_branchFreeTernary:IO,czm_cascadeColor:zO,czm_cascadeDistance:NO,czm_cascadeMatrix:DO,czm_cascadeWeights:LO,czm_clipPolygons:FO,czm_columbusViewMorph:BO,czm_computeAtmosphereColor:UO,czm_computeGroundAtmosphereScattering:GO,czm_computePosition:qO,czm_computeScattering:kO,czm_cosineAndSine:jO,czm_decompressTextureCoordinates:VO,czm_depthClamp:HO,czm_eastNorthUpToEyeCoordinates:WO,czm_ellipsoidContainsPoint:YO,czm_ellipsoidTextureCoordinates:$O,czm_equalsEpsilon:XO,czm_eyeOffset:ZO,czm_eyeToWindowCoordinates:KO,czm_fastApproximateAtan:QO,czm_fog:JO,czm_gammaCorrect:eC,czm_geodeticSurfaceNormal:tC,czm_getDefaultMaterial:nC,czm_getDynamicAtmosphereLightDirection:oC,czm_getLambertDiffuse:iC,czm_getSpecular:rC,czm_getWaterNoise:aC,czm_hue:sC,czm_inverseGamma:cC,czm_isEmpty:fC,czm_isFull:hC,czm_latitudeToWebMercatorFraction:lC,czm_lineDistance:uC,czm_linearToSrgb:dC,czm_luminance:mC,czm_maximumComponent:pC,czm_metersPerPixel:_C,czm_modelToWindowCoordinates:gC,czm_multiplyWithColorBalance:yC,czm_nearFarScalar:bC,czm_octDecode:EC,czm_packDepth:wC,czm_pbrLighting:vC,czm_pbrNeutralTonemapping:TC,czm_phong:SC,czm_planeDistance:AC,czm_pointAlongRay:xC,czm_rayEllipsoidIntersectionInterval:OC,czm_raySphereIntersectionInterval:CC,czm_readDepth:MC,czm_readNonPerspective:RC,czm_reverseLogDepth:PC,czm_round:IC,czm_saturation:zC,czm_shadowDepthCompare:NC,czm_shadowVisibility:DC,czm_signNotZero:LC,czm_sphericalHarmonics:FC,czm_srgbToLinear:BC,czm_tangentToEyeSpaceMatrix:UC,czm_textureCube:GC,czm_transformPlane:qC,czm_translateRelativeToEye:kC,czm_translucentPhong:jC,czm_transpose:VC,czm_unpackClippingExtents:HC,czm_unpackDepth:WC,czm_unpackFloat:YC,czm_unpackUint:$C,czm_valueTransform:XC,czm_vertexLogDepth:ZC,czm_windowToEyeCoordinates:KC,czm_writeDepthClamp:QC,czm_writeLogDepth:JC,czm_writeNonPerspective:e3};function t3(e,t){let n=e;return n=n.replaceAll("version 300 es",""),n=n.replaceAll(/(texture\()/g,"texture2D("),t?(n=n.replaceAll(/\n\s*(in)\s+(vec\d|mat\d|float)/g,`
...
${n}`,n}function Om(e){return e=e.replace(/\/\/.*/g,""),e.replace(/\/\*\*[\s\S]*?\*\//gm,function(t){const n=t.match(/\n/gm).length;let o="";for(let i=0;i<n;++i)o+=`
`;return o})}function Cm(e,t,n){let o;for(let i=0;i<n.length;++i)n[i].name===e&&(o=n[i]);return l(o)||(t=Om(t),o={name:e,glslSource:t,dependsOn:[],requiredBy:[],evaluated:!1},n.push(o)),o}function Mm(e,t){if(e.evaluated)return;e.evaluated=!0;let n=e.glslSource.match(/\bczm_[a-zA-Z0-9_]*/g);l(n)&&n!==null&&(n=n.filter(function(o,i){return n.indexOf(o)===i}),n.forEach(function(o){if(o!==e.name&&it._czmBuiltinsAndUniforms.hasOwnProperty(o)){const i=Cm(o,it._czmBuiltinsAndUniforms[o],t);e.dependsOn.push(i),i.requiredBy.push(e),Mm(i,t)}}))}function n3(e){const t=[],n=[];for(;e.length>0;){const i=e.pop();n.push(i),i.requiredBy.length===0&&t.push(i)}for(;t.length>0;){const i=t.shift();e.push(i);for(let r=0;r<i.dependsOn.length;++r){const a=i.dependsOn[r],s=a.requiredBy.indexOf(i);a.requiredBy.splice(s,1),a.requiredBy.length===0&&t.push(a)}}const o=[];for(let i=0;i<n.length;++i)n[i].requiredBy.length!==0&&o.push(n[i]);if(o.length!==0){let i=`A circular dependency was found in the following built-in functions/structs/constants: 
`;for(let r=0;r<o.length;++r)i=`${i+o[r].name}
`;throw new w(i)}}function o3(e){const t=[],n=Cm("main",e,t);Mm(n,t),n3(t);let o="";for(let i=t.length-1;i>=0;--i)o=`${o+t[i].glslSource}
`;return o.replace(n.glslSource,"")}function Rm(e,t,n){let o,i,r="";const a=e.sources;if(l(a))for(o=0,i=a.length;o<i;++o)r+=`
#line 0
${a[o]}`;r=Om(r);let s;r=r.replace(/#version\s+(.*?)\n/gm,function(y,E){if(l(s)&&s!==E)throw new w(`inconsistent versions found: ${s} and ${E}`);return s=E,`
...
`);let _="";e.includeBuiltIns&&(_=o3(r)),d+=`
#line 0
...
`);return`${t}:${n}:${o}:${i}`};it.prototype.createCombinedVertexShader=function(e){return Rm(this,!1,e)};it.prototype.createCombinedFragmentShader=function(e){return Rm(this,!0,e)};it._czmBuiltinsAndUniforms={};for(const e in Oc)Oc.hasOwnProperty(e)&&(it._czmBuiltinsAndUniforms[e]=Oc[e]);for(const e in Wa)if(Wa.hasOwnProperty(e)){const t=Wa[e];typeof t.getDeclaration=="function"&&(it._czmBuiltinsAndUniforms[e]=t.getDeclaration(e))}it.createPickVertexShaderSource=function(e){return`${it.replaceMain(e,"czm_old_main")}
in vec4 pickColor; 
...
`,z3=`// Thanks for the contribution Jonas
...
`;function ee(e){this.type=void 0,this.shaderSource=void 0,this.materials=void 0,this.uniforms=void 0,this._uniforms=void 0,this.translucent=void 0,this._minificationFilter=e.minificationFilter??Bt.LINEAR,this._magnificationFilter=e.magnificationFilter??ri.LINEAR,this._strict=void 0,this._template=void 0,this._count=void 0,this._texturePaths={},this._loadedImages=[],this._loadedCubeMaps=[],this._textures={},this._updateFunctions=[],this._defaultTexture=void 0,this._initializationPromises=[],this._initializationError=void 0,N3(e,this),Object.defineProperties(this,{type:{value:this.type,writable:!1},minificationFilter:{get:function(){return this._minificationFilter},set:function(t){this._minificationFilter=t}},magnificationFilter:{get:function(){return this._magnificationFilter},set:function(t){this._magnificationFilter=t}}}),l(ee._uniformList[this.type])||(ee._uniformList[this.type]=Object.keys(this._uniforms))}ee._uniformList={};ee.fromType=function(e,t){if(!l(ee._materialCache.getMaterial(e)))throw new w(`material with type '${e}' does not exist.`);const n=new ee({fabric:{type:e}});if(l(t))for(const o in t)t.hasOwnProperty(o)&&(n.uniforms[o]=t[o]);return n};ee.fromTypeAsync=async function(e,t){if(!l(ee._materialCache.getMaterial(e)))throw new w(`material with type '${e}' does not exist.`);const n=[],o=new ee({fabric:{type:e,uniforms:t}});if(Fm(o,n),await Promise.all(n),n.length=0,l(o._initializationError))throw o._initializationError;return o};function Fm(e,t){t.push(...e._initializationPromises);const n=e.materials;for(const o in n)if(n.hasOwnProperty(o)){const i=n[o];Fm(i,t)}}ee.prototype.isTranslucent=function(){if(l(this.translucent))return typeof this.translucent=="function"?this.translucent():this.translucent;let e=!0;const t=this._translucentFunctions,n=t.length;for(let o=0;o<n;++o){const i=t[o];if(typeof i=="function"?e=e&&i():e=e&&i,!e)break}return e};ee.prototype.update=function(e){this._defaultTexture=e.defaultTexture;let t,n;const o=this._loadedImages;let i=o.length;for(t=0;t<i;++t){const c=o[t];n=c.id;let f=c.image,d;Array.isArray(f)&&(d=f.slice(1,f.length).map(function(y){return y.bufferView}),f=f[0]);const u=new oo({minificationFilter:this._minificationFilter,magnificationFilter:this._magnificationFilter});let m;l(f.internalFormat)?m=new Kt({context:e,pixelFormat:f.internalFormat,width:f.width,height:f.height,source:{arrayBufferView:f.bufferView,mipLevels:d},sampler:u}):m=new Kt({context:e,source:f,sampler:u});const _=this._textures[n];l(_)&&_!==this._defaultTexture&&_.destroy(),this._textures[n]=m;const g=`${n}Dimensions`;if(this.uniforms.hasOwnProperty(g)){const y=this.uniforms[g];y.x=m._width,y.y=m._height}}o.length=0;const r=this._loadedCubeMaps;for(i=r.length,t=0;t<i;++t){const c=r[t];n=c.id;const f=c.images,d=new Je({context:e,source:{positiveX:f[0],negativeX:f[1],positiveY:f[2],negativeY:f[3],positiveZ:f[4],negativeZ:f[5]},sampler:new oo({minificationFilter:this._minificationFilter,magnificationFilter:this._magnificationFilter})});this._textures[n]=d}r.length=0;const a=this._updateFunctions;for(i=a.length,t=0;t<i;++t)a[t](this,e);const s=this.materials;for(const c in s)s.hasOwnProperty(c)&&s[c].update(e)};ee.prototype.isDestroyed=function(){return!1};ee.prototype.destroy=function(){const e=this._textures;for(const n in e)if(e.hasOwnProperty(n)){const o=e[n];o!==this._defaultTexture&&o.destroy()}const t=this.materials;for(const n in t)t.hasOwnProperty(n)&&t[n].destroy();return Ft(this)};function N3(e,t){e=e??xe.EMPTY_OBJECT,t._strict=e.strict??!1,t._count=e.count??0,t._template=en(e.fabric??xe.EMPTY_OBJECT),t.fabric=en(e.fabric??xe.EMPTY_OBJECT),t._template.uniforms=en(t._template.uniforms??xe.EMPTY_OBJECT),t._template.materials=en(t._template.materials??xe.EMPTY_OBJECT),t.type=l(t._template.type)?t._template.type:ah(),t.shaderSource="",t.materials={},t.uniforms={},t._uniforms={},t._translucentFunctions=[];let n;const o=ee._materialCache.getMaterial(t.type);if(l(o)){const r=en(o.fabric,!0);t._template=nn(t._template,r,!0),n=o.translucent}B3(t),G3(t),V3(t),W3(t),l(o)||ee._materialCache.addMaterial(t.type,t);const i=t._translucentFunctions.length===0?!0:void 0;if(n=n??i,n=e.translucent??n,l(n))if(typeof n=="function"){const r=function(){return n(t)};t._translucentFunctions.push(r)}else t._translucentFunctions.push(n)}function Cc(e,t,n,o){if(l(e)){for(const i in e)if(e.hasOwnProperty(i)){const r=t.indexOf(i)!==-1;(o&&!r||!o&&r)&&n(i,t)}}}function Au(e,t){let n=`fabric: property name '${e}' is not valid. It should be `;for(let o=0;o<t.length;o++){const i=`'${t[o]}'`;n+=o===t.length-1?`or ${i}.`:`${i}, `}throw new w(n)}function D3(e,t){const n=`fabric: uniforms and materials cannot share the same property '${e}'`;throw new w(n)}const L3=["type","materials","uniforms","components","source"],F3=["diffuse","specular","shininess","normal","emission","alpha"];function B3(e){const t=e._template,n=t.uniforms,o=t.materials,i=t.components;if(l(i)&&l(t.source))throw new w("fabric: cannot have source and components in the same template.");Cc(t,L3,Au,!0),Cc(i,F3,Au,!0);const r=[];for(const a in o)o.hasOwnProperty(a)&&r.push(a);Cc(n,r,D3,!1)}function U3(e,t){const n=t._template.materials;for(const o in n)if(n.hasOwnProperty(o)&&e.indexOf(o)>-1)return!0;return!1}function G3(e){const t=e._template.components,n=e._template.source;if(l(n))e.shaderSource+=`${n}
`;else{if(e.shaderSource+=`czm_material czm_getMaterial(czm_materialInput materialInput)
{
`,e.shaderSource+=`czm_material material = czm_getDefaultMaterial(materialInput);
`,l(t)){const o=Object.keys(e._template.materials).length>0;for(const i in t)if(t.hasOwnProperty(i))if(i==="diffuse"||i==="emission"){const a=o&&U3(t[i],e)?t[i]:`czm_gammaCorrect(${t[i]})`;e.shaderSource+=`material.${i} = ${a}; 
`}else i==="alpha"?e.shaderSource+=`material.alpha = ${t.alpha}; 
`:e.shaderSource+=`material.${i} = ${t[i]};
`}e.shaderSource+=`return material;
}
`}}const xu={mat2:ge,mat3:B,mat4:U},q3=/\.ktx2$/i;function k3(e){let t;return function(n,o){const i=n.uniforms,r=i[e],a=t!==r,s=!l(r)||r===ee.DefaultImageId;t=r;let c=n._textures[e],f,d;if(r instanceof HTMLVideoElement){if(r.readyState>=2){if(a&&l(c)&&(c!==o.defaultTexture&&c.destroy(),c=void 0),!l(c)||c===o.defaultTexture){const u=new oo({minificationFilter:n._minificationFilter,magnificationFilter:n._magnificationFilter});c=new Kt({context:o,source:r,sampler:u}),n._textures[e]=c;return}c.copyFrom({source:r})}else l(c)||(n._textures[e]=o.defaultTexture);return}if(r instanceof Kt&&r!==c){n._texturePaths[e]=void 0;const u=n._textures[e];l(u)&&u!==n._defaultTexture&&u.destroy(),n._textures[e]=r,f=`${e}Dimensions`,i.hasOwnProperty(f)&&(d=i[f],d.x=r._width,d.y=r._height);return}if(a&&l(c)&&s&&(c!==n._defaultTexture&&c.destroy(),c=void 0,n._texturePaths[e]=void 0),l(c)||(c=n._textures[e]=n._defaultTexture,f=`${e}Dimensions`,i.hasOwnProperty(f)&&(d=i[f],d.x=c._width,d.y=c._height)),!s){if((r instanceof HTMLCanvasElement||r instanceof HTMLImageElement||r instanceof ImageBitmap||r instanceof OffscreenCanvas)&&r!==n._texturePaths[e]){n._loadedImages.push({id:e,image:r}),n._texturePaths[e]=r;return}Bm(n,e)}}}function Bm(e,t){const o=e.uniforms[t];if(o===ee.DefaultImageId)return Promise.resolve();const i=se.createIfNeeded(o);if(!(i instanceof se))return Promise.resolve();const r=se.createIfNeeded(e._texturePaths[t]);if(!(!l(r)||r.url!==i.url))return Promise.resolve();let s;return q3.test(i.url)?s=Gd(i.url):s=i.fetchImage(),Promise.resolve(s).then(function(c){e._loadedImages.push({id:t,image:c})}).catch(function(c){e._initializationError=c;const f=e._textures[t];l(f)&&f!==e._defaultTexture&&f.destroy(),e._textures[t]=e._defaultTexture}),e._texturePaths[t]=o,s}function j3(e){return function(t,n){const o=t.uniforms[e];if(o instanceof Je){const i=t._textures[e];i!==t._defaultTexture&&i.destroy(),t._texturePaths[e]=void 0,t._textures[e]=o;return}l(t._textures[e])||(t._textures[e]=n.defaultCubeMap),Um(t,e)}}function Um(e,t){const o=e.uniforms[t];if(o===ee.DefaultCubeMapId)return Promise.resolve();const i=o.positiveX+o.negativeX+o.positiveY+o.negativeY+o.positiveZ+o.negativeZ;if(i===e._texturePaths[t])return Promise.resolve();const r=[se.createIfNeeded(o.positiveX).fetchImage(),se.createIfNeeded(o.negativeX).fetchImage(),se.createIfNeeded(o.positiveY).fetchImage(),se.createIfNeeded(o.negativeY).fetchImage(),se.createIfNeeded(o.positiveZ).fetchImage(),se.createIfNeeded(o.negativeZ).fetchImage()],a=Promise.all(r);return a.then(function(s){e._loadedCubeMaps.push({id:t,images:s})}).catch(function(s){e._initializationError=s}),e._texturePaths[t]=i,a}function V3(e){const t=e._template.uniforms;for(const n in t)t.hasOwnProperty(n)&&Gm(e,n)}function Gm(e,t){const n=e._strict,o=e._template.uniforms,i=o[t],r=H3(i);if(!l(r))throw new w(`fabric: uniform '${t}' has invalid type.`);let a;if(r==="channels"){if(a=qr(e,t,i,!1),a===0&&n)throw new w(`strict: shader source does not use channels '${t}'.`)}else{if(r==="sampler2D"){const f=`${t}Dimensions`;Y3(e,f)>0&&(o[f]={type:"ivec3",x:1,y:1},Gm(e,f))}if(!new RegExp(`uniform\\s+${r}\\s+${t}\\s*;`).test(e.shaderSource)){const f=`uniform ${r} ${t};`;e.shaderSource=f+e.shaderSource}const c=`${t}_${e._count++}`;if(a=qr(e,t,c),a===1&&n)throw new w(`strict: shader source does not use uniform '${t}'.`);if(e.uniforms[t]=i,r==="sampler2D")e._uniforms[c]=function(){return e._textures[t]},e._updateFunctions.push(k3(t)),e._initializationPromises.push(Bm(e,t));else if(r==="samplerCube")e._uniforms[c]=function(){return e._textures[t]},e._updateFunctions.push(j3(t)),e._initializationPromises.push(Um(e,t));else if(r.indexOf("mat")!==-1){const f=new xu[r];e._uniforms[c]=function(){return xu[r].fromColumnMajorArray(e.uniforms[t],f)}}else e._uniforms[c]=function(){return e.uniforms[t]}}}function H3(e){let t=e.type;if(!l(t)){const n=typeof e;if(n==="number")t="float";else if(n==="boolean")t="bool";else if(n==="string"||e instanceof se||e instanceof HTMLCanvasElement||e instanceof HTMLImageElement||e instanceof ImageBitmap||e instanceof OffscreenCanvas)/^([rgba]){1,4}$/i.test(e)?t="channels":e===ee.DefaultCubeMapId?t="samplerCube":t="sampler2D";else if(n==="object")if(Array.isArray(e))(e.length===4||e.length===9||e.length===16)&&(t=`mat${Math.sqrt(e.length)}`);else{let o=0;for(const i in e)e.hasOwnProperty(i)&&(o+=1);o>=2&&o<=4?t=`vec${o}`:o===6&&(t="samplerCube")}}return t}function W3(e){const t=e._strict,n=e._template.materials;for(const o in n)if(n.hasOwnProperty(o)){const i=new ee({strict:t,fabric:n[o],count:e._count});e._count=i._count,e._uniforms=nn(e._uniforms,i._uniforms,!0),e.materials[o]=i,e._translucentFunctions=e._translucentFunctions.concat(i._translucentFunctions);const r="czm_getMaterial",a=`${r}_${e._count++}`;qr(i,r,a),e.shaderSource=i.shaderSource+e.shaderSource;const s=`${a}(materialInput)`;if(qr(e,o,s)===0&&t)throw new w(`strict: shader source does not use material '${o}'.`)}}function qr(e,t,n,o){o=o??!0;let i=0;const r="([\\w])?",a=`([\\w${o?".":""}])?`,s=new RegExp(a+t+r,"g");return e.shaderSource=e.shaderSource.replace(s,function(c,f,d){return f||d?c:(i+=1,n)}),i}function Y3(e,t,n){return qr(e,t,t,n)}ee._materialCache={_materials:{},addMaterial:function(e,t){this._materials[e]=t},getMaterial:function(e){return this._materials[e]}};ee.DefaultImageId="czm_defaultImage";ee.DefaultCubeMapId="czm_defaultCubeMap";ee.ColorType="Color";ee._materialCache.addMaterial(ee.ColorType,{fabric:{type:ee.ColorType,uniforms:{color:new x(1,0,0,.5)},components:{diffuse:"color.rgb",alpha:"color.a"}},translucent:function(e){return e.uniforms.color.alpha<1}});ee.ImageType="Image";ee._materialCache.addMaterial(ee.ImageType,{fabric:{type:ee.ImageType,uniforms:{image:ee.DefaultImageId,repeat:new V(1,1),color:new x(1,1,1,1)},components:{diffuse:"texture(image, fract(repeat * materialInput.st)).rgb * color.rgb",alpha:"texture(image, fract(repeat * materialInput.st)).a * color.a"}},translucent:function(e){return e.uniforms.color.alpha<1}});ee.DiffuseMapType="DiffuseMap";ee._materialCache.addMaterial(ee.DiffuseMapType,{fabric:{type:ee.DiffuseMapType,uniforms:{image:ee.DefaultImageId,channels:"rgb",repeat:new V(1,1)},components:{diffuse:"texture(image, fract(repeat * materialInput.st)).channels"}},translucent:!1});ee.AlphaMapType="AlphaMap";ee._materialCache.addMaterial(ee.AlphaMapType,{fabric:{type:ee.AlphaMapType,uniforms:{image:ee.DefaultImageId,channel:"a",repeat:new V(1,1)},components:{alpha:"texture(image, fract(repeat * materialInput.st)).channel"}},translucent:!0});ee.SpecularMapType="SpecularMap";ee._materialCache.addMaterial(ee.SpecularMapType,{fabric:{type:ee.SpecularMapType,uniforms:{image:ee.DefaultImageId,channel:"r",repeat:new V(1,1)},components:{specular:"texture(image, fract(repeat * materialInput.st)).channel"}},translucent:!1});ee.EmissionMapType="EmissionMap";ee._materialCache.addMaterial(ee.EmissionMapType,{fabric:{type:ee.EmissionMapType,uniforms:{image:ee.DefaultImageId,channels:"rgb",repeat:new V(1,1)},components:{emission:"texture(image, fract(repeat * materialInput.st)).channels"}},translucent:!1});ee.BumpMapType="BumpMap";ee._materialCache.addMaterial(ee.BumpMapType,{fabric:{type:ee.BumpMapType,uniforms:{image:ee.DefaultImageId,channel:"r",strength:.8,repeat:new V(1,1)},source:_3},translucent:!1});ee.NormalMapType="NormalMap";ee._materialCache.addMaterial(ee.NormalMapType,{fabric:{type:ee.NormalMapType,uniforms:{image:ee.DefaultImageId,channels:"rgb",strength:.8,repeat:new V(1,1)},source:S3},translucent:!1});ee.GridType="Grid";ee._materialCache.addMaterial(ee.GridType,{fabric:{type:ee.GridType,uniforms:{color:new x(0,1,0,1),cellAlpha:.1,lineCount:new V(8,8),lineThickness:new V(1,1),lineOffset:new V(0,0)},source:T3},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.cellAlpha<1}});ee.StripeType="Stripe";ee._materialCache.addMaterial(ee.StripeType,{fabric:{type:ee.StripeType,uniforms:{horizontal:!0,evenColor:new x(1,1,1,.5),oddColor:new x(0,0,1,.5),offset:0,repeat:5},source:P3},translucent:function(e){const t=e.uniforms;return t.evenColor.alpha<1||t.oddColor.alpha<1}});ee.CheckerboardType="Checkerboard";ee._materialCache.addMaterial(ee.CheckerboardType,{fabric:{type:ee.CheckerboardType,uniforms:{lightColor:new x(1,1,1,.5),darkColor:new x(0,0,0,.5),repeat:new V(5,5)},source:g3},translucent:function(e){const t=e.uniforms;return t.lightColor.alpha<1||t.darkColor.alpha<1}});ee.DotType="Dot";ee._materialCache.addMaterial(ee.DotType,{fabric:{type:ee.DotType,uniforms:{lightColor:new x(1,1,0,.75),darkColor:new x(0,1,1,.75),repeat:new V(5,5)},source:y3},translucent:function(e){const t=e.uniforms;return t.lightColor.alpha<1||t.darkColor.alpha<1}});ee.WaterType="Water";ee._materialCache.addMaterial(ee.WaterType,{fabric:{type:ee.WaterType,uniforms:{baseWaterColor:new x(.2,.3,.6,1),blendColor:new x(0,1,.699,1),specularMap:ee.DefaultImageId,normalMap:ee.DefaultImageId,frequency:10,animationSpeed:.01,amplitude:1,specularIntensity:.5,fadeFactor:1},source:z3},translucent:function(e){const t=e.uniforms;return t.baseWaterColor.alpha<1||t.blendColor.alpha<1}});ee.RimLightingType="RimLighting";ee._materialCache.addMaterial(ee.RimLightingType,{fabric:{type:ee.RimLightingType,uniforms:{color:new x(1,0,0,.7),rimColor:new x(1,1,1,.4),width:.3},source:M3},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.rimColor.alpha<1}});ee.FadeType="Fade";ee._materialCache.addMaterial(ee.FadeType,{fabric:{type:ee.FadeType,uniforms:{fadeInColor:new x(1,0,0,1),fadeOutColor:new x(0,0,0,0),maximumDistance:.5,repeat:!0,fadeDirection:{x:!0,y:!0},time:new V(.5,.5)},source:v3},translucent:function(e){const t=e.uniforms;return t.fadeInColor.alpha<1||t.fadeOutColor.alpha<1}});ee.PolylineArrowType="PolylineArrow";ee._materialCache.addMaterial(ee.PolylineArrowType,{fabric:{type:ee.PolylineArrowType,uniforms:{color:new x(1,1,1,1)},source:A3},translucent:!0});ee.PolylineDashType="PolylineDash";ee._materialCache.addMaterial(ee.PolylineDashType,{fabric:{type:ee.PolylineDashType,uniforms:{color:new x(1,0,1,1),gapColor:new x(0,0,0,0),dashLength:16,dashPattern:255},source:x3},translucent:!0});ee.PolylineGlowType="PolylineGlow";ee._materialCache.addMaterial(ee.PolylineGlowType,{fabric:{type:ee.PolylineGlowType,uniforms:{color:new x(0,.5,1,1),glowPower:.25,taperPower:1},source:O3},translucent:!0});ee.PolylineOutlineType="PolylineOutline";ee._materialCache.addMaterial(ee.PolylineOutlineType,{fabric:{type:ee.PolylineOutlineType,uniforms:{color:new x(1,1,1,1),outlineColor:new x(1,0,0,1),outlineWidth:1},source:C3},translucent:function(e){const t=e.uniforms;return t.color.alpha<1||t.outlineColor.alpha<1}});ee.ElevationContourType="ElevationContour";ee._materialCache.addMaterial(ee.ElevationContourType,{fabric:{type:ee.ElevationContourType,uniforms:{spacing:100,color:new x(1,0,0,1),width:1},source:E3},translucent:!1});ee.ElevationRampType="ElevationRamp";ee._materialCache.addMaterial(ee.ElevationRampType,{fabric:{type:ee.ElevationRampType,uniforms:{image:ee.DefaultImageId,minimumHeight:0,maximumHeight:1e4},source:w3},translucent:!1});ee.SlopeRampMaterialType="SlopeRamp";ee._materialCache.addMaterial(ee.SlopeRampMaterialType,{fabric:{type:ee.SlopeRampMaterialType,uniforms:{image:ee.DefaultImageId},source:R3},translucent:!1});ee.AspectRampMaterialType="AspectRamp";ee._materialCache.addMaterial(ee.AspectRampMaterialType,{fabric:{type:ee.AspectRampMaterialType,uniforms:{image:ee.DefaultImageId},source:p3},translucent:!1});ee.ElevationBandType="ElevationBand";ee._materialCache.addMaterial(ee.ElevationBandType,{fabric:{type:ee.ElevationBandType,uniforms:{heights:ee.DefaultImageId,colors:ee.DefaultImageId},source:b3},translucent:!0});ee.WaterMaskType="WaterMask";ee._materialCache.addMaterial(ee.WaterMaskType,{fabric:{type:ee.WaterMaskType,source:I3,uniforms:{waterColor:new x(1,1,1,1),landColor:new x(0,0,0,0)}},translucent:!1});const $3={NEVER:I.NEVER,LESS:I.LESS,EQUAL:I.EQUAL,LESS_OR_EQUAL:I.LEQUAL,GREATER:I.GREATER,NOT_EQUAL:I.NOTEQUAL,GREATER_OR_EQUAL:I.GEQUAL,ALWAYS:I.ALWAYS},X3=Object.freeze($3);function io(e,t,n){if(!l(e))throw new w("context is required");if(!l(t))throw new w("attributes is required");if(!l(n))throw new w("numberOfInstances is required");if(this._attributes=t,this._numberOfInstances=n,t.length===0)return;const o=Z3(t),i=e.floatingPointTexture,r=o===Oe.FLOAT&&!i,a=K3(t,r),s=Q3(a,t,r),c=Math.floor(Ie.maximumTextureSize/s),f=Math.min(n,c),d=s*f,u=Math.ceil(n/f),m=1/d,_=m*.5,g=1/u,y=g*.5;this._textureDimensions=new V(d,u),this._textureStep=new Q(m,_,g,y),this._pixelDatatype=r?Oe.UNSIGNED_BYTE:o,this._packFloats=r,this._offsets=a,this._stride=s,this._texture=void 0;const E=4*d*u;this._batchValues=o===Oe.FLOAT&&!r?new Float32Array(E):new Uint8Array(E),this._batchValuesDirty=!1}Object.defineProperties(io.prototype,{attributes:{get:function(){return this._attributes}},numberOfInstances:{get:function(){return this._numberOfInstances}}});function Z3(e){let t=!1;const n=e.length;for(let o=0;o<n;++o)if(e[o].componentDatatype!==ue.UNSIGNED_BYTE){t=!0;break}return t?Oe.FLOAT:Oe.UNSIGNED_BYTE}function qm(e,t){const n=e[t].componentsPerAttribute;return n===2?V:n===3?h:n===4?Q:Number}function K3(e,t){const n=new Array(e.length);let o=0;const i=e.length;for(let r=0;r<i;++r){const s=e[r].componentDatatype;n[r]=o,s!==ue.UNSIGNED_BYTE&&t?o+=4:++o}return n}function Q3(e,t,n){const o=e.length,i=e[o-1];return t[o-1].componentDatatype!==ue.UNSIGNED_BYTE&&n?i+4:i+1}const yr=new Q;function J3(e,t,n){let o=Q.unpack(e,t,yr);const i=Q.unpackFloat(o);o=Q.unpack(e,t+4,yr);const r=Q.unpackFloat(o);o=Q.unpack(e,t+8,yr);const a=Q.unpackFloat(o);o=Q.unpack(e,t+12,yr);const s=Q.unpackFloat(o);return Q.fromElements(i,r,a,s,n)}function eM(e,t,n){let o=Q.packFloat(e.x,yr);Q.pack(o,t,n),o=Q.packFloat(e.y,o),Q.pack(o,t,n+4),o=Q.packFloat(e.z,o),Q.pack(o,t,n+8),o=Q.packFloat(e.w,o),Q.pack(o,t,n+12)}const Ou=new Q;io.prototype.getBatchedAttribute=function(e,t,n){if(e<0||e>=this._numberOfInstances)throw new w("instanceIndex is out of range.");if(t<0||t>=this._attributes.length)throw new w("attributeIndex is out of range");const o=this._attributes,i=this._offsets[t],a=4*this._stride*e+4*i;let s;this._packFloats&&o[t].componentDatatype!==Oe.UNSIGNED_BYTE?s=J3(this._batchValues,a,Ou):s=Q.unpack(this._batchValues,a,Ou);const c=qm(o,t);return l(c.fromCartesian4)?c.fromCartesian4(s,n):l(c.clone)?c.clone(s,n):s.x};const tM=[void 0,void 0,new V,new h,new Q],nM=new Q;io.prototype.setBatchedAttribute=function(e,t,n){if(e<0||e>=this._numberOfInstances)throw new w("instanceIndex is out of range.");if(t<0||t>=this._attributes.length)throw new w("attributeIndex is out of range");if(!l(n))throw new w("value is required.");const o=this._attributes,i=tM[o[t].componentsPerAttribute],r=this.getBatchedAttribute(e,t,i),a=qm(this._attributes,t);if(l(a.equals)?a.equals(r,n):r===n)return;const c=nM;c.x=l(n.x)?n.x:n,c.y=l(n.y)?n.y:0,c.z=l(n.z)?n.z:0,c.w=l(n.w)?n.w:0;const f=this._offsets[t],u=4*this._stride*e+4*f;this._packFloats&&o[t].componentDatatype!==Oe.UNSIGNED_BYTE?eM(c,this._batchValues,u):Q.pack(c,this._batchValues,u),this._batchValuesDirty=!0};function oM(e,t){const n=e._textureDimensions;e._texture=new Kt({context:t,pixelFormat:Me.RGBA,pixelDatatype:e._pixelDatatype,width:n.x,height:n.y,sampler:oo.NEAREST,flipY:!1})}function iM(e){const t=e._textureDimensions;e._texture.copyFrom({source:{width:t.x,height:t.y,arrayBufferView:e._batchValues}})}io.prototype.update=function(e){l(this._texture)&&!this._batchValuesDirty||this._attributes.length===0||(this._batchValuesDirty=!1,l(this._texture)||oM(this,e.context),iM(this))};io.prototype.getUniformMapCallback=function(){const e=this;return function(t){return e._attributes.length===0?t:nn(t,{batchTexture:function(){return e._texture},batchTextureDimensions:function(){return e._textureDimensions},batchTextureStep:function(){return e._textureStep}})}};function rM(e){const t=e._stride;return e._textureDimensions.y===1?`uniform vec4 batchTextureStep; 
...
`}function aM(e){return e===1?"float":`vec${e}`}function sM(e){return e===1?".x":e===2?".xy":e===3?".xyz":""}function cM(e,t){const o=e._attributes[t],i=o.componentsPerAttribute,r=o.functionName,a=aM(i),s=sM(i),c=e._offsets[t];let f=`${a} ${r}(float batchId) 
{ 
...
`,f}io.prototype.getVertexShaderCallback=function(){const e=this._attributes;if(e.length===0)return function(o){return o};let t=`uniform highp sampler2D batchTexture; 
`;t+=`${rM(this)}
`;const n=e.length;for(let o=0;o<n;++o)t+=cM(this,o);return function(o){const i=o.indexOf("void main"),r=o.substring(0,i),a=o.substring(i);return`${r}
${t}
${a}`}};io.prototype.isDestroyed=function(){return!1};io.prototype.destroy=function(){return this._texture=this._texture&&this._texture.destroy(),Ft(this)};function fM(e,t,n){let o=!n;const i=e.length;let r;if(!o&&i>1){const a=e[0].modelMatrix;for(r=1;r<i;++r)if(!U.equals(a,e[r].modelMatrix)){o=!0;break}}if(o)for(r=0;r<i;++r)l(e[r].geometry)&&We.transformToWorldCoordinates(e[r]);else U.multiplyTransformation(t,e[0].modelMatrix,t)}function Mc(e,t){const n=e.attributes,o=n.position,i=o.values.length/o.componentsPerAttribute;n.batchId=new Ue({componentDatatype:ue.FLOAT,componentsPerAttribute:1,values:new Float32Array(i)});const r=n.batchId.values;for(let a=0;a<i;++a)r[a]=t}function hM(e){const t=e.length;for(let n=0;n<t;++n){const o=e[n];l(o.geometry)?Mc(o.geometry,n):l(o.westHemisphereGeometry)&&l(o.eastHemisphereGeometry)&&(Mc(o.westHemisphereGeometry,n),Mc(o.eastHemisphereGeometry,n))}}function lM(e){const t=e.instances,n=e.projection,o=e.elementIndexUintSupported,i=e.scene3DOnly,r=e.vertexCacheOptimize,a=e.compressVertices,s=e.modelMatrix;let c,f,d,u=t.length;for(c=0;c<u;++c)if(l(t[c].geometry)){d=t[c].geometry.primitiveType;break}for(c=1;c<u;++c)if(l(t[c].geometry)&&t[c].geometry.primitiveType!==d)throw new w("All instance geometries must have the same primitiveType.");if(fM(t,s,i),!i)for(c=0;c<u;++c)l(t[c].geometry)&&We.splitLongitude(t[c]);if(hM(t),r)for(c=0;c<u;++c){const _=t[c];l(_.geometry)?(We.reorderForPostVertexCache(_.geometry),We.reorderForPreVertexCache(_.geometry)):l(_.westHemisphereGeometry)&&l(_.eastHemisphereGeometry)&&(We.reorderForPostVertexCache(_.westHemisphereGeometry),We.reorderForPreVertexCache(_.westHemisphereGeometry),We.reorderForPostVertexCache(_.eastHemisphereGeometry),We.reorderForPreVertexCache(_.eastHemisphereGeometry))}let m=We.combineInstances(t);for(u=m.length,c=0;c<u;++c){f=m[c];const _=f.attributes;if(i)for(const g in _)_.hasOwnProperty(g)&&_[g].componentDatatype===ue.DOUBLE&&We.encodeAttribute(f,g,`${g}3DHigh`,`${g}3DLow`);else for(const g in _)if(_.hasOwnProperty(g)&&_[g].componentDatatype===ue.DOUBLE){const y=`${g}3D`,E=`${g}2D`;We.projectTo2D(f,g,y,E,n),l(f.boundingSphere)&&g==="position"&&(f.boundingSphereCV=ie.fromVertices(f.attributes.position2D.values)),We.encodeAttribute(f,y,`${y}High`,`${y}Low`),We.encodeAttribute(f,E,`${E}High`,`${E}Low`)}a&&We.compressVertices(f)}if(!o){let _=[];for(u=m.length,c=0;c<u;++c)f=m[c],_=_.concat(We.fitToUnsignedShortIndices(f));m=_}return m}function Rc(e,t,n,o){let i,r,a;const s=o.length-1;if(s>=0){const f=o[s];i=f.offset+f.count,a=f.index,r=n[a].indices.length}else i=0,a=0,r=n[a].indices.length;const c=e.length;for(let f=0;f<c;++f){const u=e[f][t];if(!l(u))continue;const m=u.indices.length;i+m>r&&(i=0,r=n[++a].indices.length),o.push({index:a,offset:i,count:m}),i+=m}}function uM(e,t){const n=[];return Rc(e,"geometry",t,n),Rc(e,"westHemisphereGeometry",t,n),Rc(e,"eastHemisphereGeometry",t,n),n}const kn={};kn.combineGeometry=function(e){let t,n;const o=e.instances,i=o.length;let r,a,s=!1;i>0&&(t=lM(e),t.length>0&&(n=We.createAttributeLocations(t[0]),e.createPickOffsets&&(r=uM(o,t))),l(o[0].attributes)&&l(o[0].attributes.offset)&&(a=new Array(i),s=!0));const c=new Array(i),f=new Array(i);for(let d=0;d<i;++d){const u=o[d],m=u.geometry;l(m)&&(c[d]=m.boundingSphere,f[d]=m.boundingSphereCV,s&&(a[d]=u.geometry.offsetAttribute));const _=u.eastHemisphereGeometry,g=u.westHemisphereGeometry;l(_)&&l(g)&&(l(_.boundingSphere)&&l(g.boundingSphere)&&(c[d]=ie.union(_.boundingSphere,g.boundingSphere)),l(_.boundingSphereCV)&&l(g.boundingSphereCV)&&(f[d]=ie.union(_.boundingSphereCV,g.boundingSphereCV)))}return{geometries:t,modelMatrix:e.modelMatrix,attributeLocations:n,pickOffsets:r,offsetInstanceExtend:a,boundingSpheres:c,boundingSpheresCV:f}};function dM(e,t){const n=e.attributes;for(const o in n)if(n.hasOwnProperty(o)){const i=n[o];l(i)&&l(i.values)&&t.push(i.values.buffer)}l(e.indices)&&t.push(e.indices.buffer)}function mM(e,t){const n=e.length;for(let o=0;o<n;++o)dM(e[o],t)}function pM(e){let t=1;const n=e.length;for(let o=0;o<n;o++){const i=e[o];if(++t,!l(i))continue;const r=i.attributes;t+=7+2*ie.packedLength+(l(i.indices)?i.indices.length:0);for(const a in r)if(r.hasOwnProperty(a)&&l(r[a])){const s=r[a];t+=5+s.values.length}}return t}kn.packCreateGeometryResults=function(e,t){const n=new Float64Array(pM(e)),o=[],i={},r=e.length;let a=0;n[a++]=r;for(let s=0;s<r;s++){const c=e[s],f=l(c);if(n[a++]=f?1:0,!f)continue;n[a++]=c.primitiveType,n[a++]=c.geometryType,n[a++]=c.offsetAttribute??-1;const d=l(c.boundingSphere)?1:0;n[a++]=d,d&&ie.pack(c.boundingSphere,n,a),a+=ie.packedLength;const u=l(c.boundingSphereCV)?1:0;n[a++]=u,u&&ie.pack(c.boundingSphereCV,n,a),a+=ie.packedLength;const m=c.attributes,_=[];for(const y in m)m.hasOwnProperty(y)&&l(m[y])&&(_.push(y),l(i[y])||(i[y]=o.length,o.push(y)));n[a++]=_.length;for(let y=0;y<_.length;y++){const E=_[y],A=m[E];n[a++]=i[E],n[a++]=A.componentDatatype,n[a++]=A.componentsPerAttribute,n[a++]=A.normalize?1:0,n[a++]=A.values.length,n.set(A.values,a),a+=A.values.length}const g=l(c.indices)?c.indices.length:0;n[a++]=g,g>0&&(n.set(c.indices,a),a+=g)}return t.push(n.buffer),{stringTable:o,packedData:n}};kn.unpackCreateGeometryResults=function(e){const t=e.stringTable,n=e.packedData;let o;const i=new Array(n[0]);let r=0,a=1;for(;a<n.length;){if(!(n[a++]===1)){i[r++]=void 0;continue}const c=n[a++],f=n[a++];let d=n[a++];d===-1&&(d=void 0);let u,m;n[a++]===1&&(u=ie.unpack(n,a)),a+=ie.packedLength,n[a++]===1&&(m=ie.unpack(n,a)),a+=ie.packedLength;let y,E,A;const S=new Kr,O=n[a++];for(o=0;o<O;o++){const R=t[n[a++]],N=n[a++];A=n[a++];const F=n[a++]!==0;y=n[a++],E=ue.createTypedArray(N,y);for(let z=0;z<y;z++)E[z]=n[a++];S[R]=new Ue({componentDatatype:N,componentsPerAttribute:A,normalize:F,values:E})}let M;if(y=n[a++],y>0){const R=E.length/A;for(M=gt.createTypedArray(R,y),o=0;o<y;o++)M[o]=n[a++]}i[r++]=new tt({primitiveType:c,geometryType:f,boundingSphere:u,boundingSphereCV:m,indices:M,attributes:S,offsetAttribute:d})}return i};function _M(e,t){const n=e.length,o=new Float64Array(1+n*19);let i=0;o[i++]=n;for(let r=0;r<n;r++){const a=e[r];if(U.pack(a.modelMatrix,o,i),i+=U.packedLength,l(a.attributes)&&l(a.attributes.offset)){const s=a.attributes.offset.value;o[i]=s[0],o[i+1]=s[1],o[i+2]=s[2]}i+=3}return t.push(o.buffer),o}function gM(e){const t=e,n=new Array(t[0]);let o=0,i=1;for(;i<t.length;){const r=U.unpack(t,i);let a;i+=U.packedLength,l(t[i])&&(a={offset:new Gr(t[i],t[i+1],t[i+2])}),i+=3,n[o++]={modelMatrix:r,attributes:a}}return n}kn.packCombineGeometryParameters=function(e,t){const n=e.createGeometryResults,o=n.length;for(let i=0;i<o;i++)t.push(n[i].packedData.buffer);return{createGeometryResults:e.createGeometryResults,packedInstances:_M(e.instances,t),ellipsoid:e.ellipsoid,isGeographic:e.projection instanceof Eo,elementIndexUintSupported:e.elementIndexUintSupported,scene3DOnly:e.scene3DOnly,vertexCacheOptimize:e.vertexCacheOptimize,compressVertices:e.compressVertices,modelMatrix:e.modelMatrix,createPickOffsets:e.createPickOffsets}};kn.unpackCombineGeometryParameters=function(e){const t=gM(e.packedInstances),n=e.createGeometryResults,o=n.length;let i=0;for(let s=0;s<o;s++){const c=kn.unpackCreateGeometryResults(n[s]),f=c.length;for(let d=0;d<f;d++){const u=c[d],m=t[i];m.geometry=u,++i}}const r=be.clone(e.ellipsoid),a=e.isGeographic?new Eo(r):new fn(r);return{instances:t,ellipsoid:r,projection:a,elementIndexUintSupported:e.elementIndexUintSupported,scene3DOnly:e.scene3DOnly,vertexCacheOptimize:e.vertexCacheOptimize,compressVertices:e.compressVertices,modelMatrix:U.clone(e.modelMatrix),createPickOffsets:e.createPickOffsets}};function Cu(e){const t=e.length,n=1+(ie.packedLength+1)*t,o=new Float32Array(n);let i=0;o[i++]=t;for(let r=0;r<t;++r){const a=e[r];l(a)?(o[i++]=1,ie.pack(e[r],o,i)):o[i++]=0,i+=ie.packedLength}return o}function Mu(e){const t=new Array(e[0]);let n=0,o=1;for(;o<e.length;)e[o++]===1&&(t[n]=ie.unpack(e,o)),++n,o+=ie.packedLength;return t}kn.packCombineGeometryResults=function(e,t){l(e.geometries)&&mM(e.geometries,t);const n=Cu(e.boundingSpheres),o=Cu(e.boundingSpheresCV);return t.push(n.buffer,o.buffer),{geometries:e.geometries,attributeLocations:e.attributeLocations,modelMatrix:e.modelMatrix,pickOffsets:e.pickOffsets,offsetInstanceExtend:e.offsetInstanceExtend,boundingSpheres:n,boundingSpheresCV:o}};kn.unpackCombineGeometryResults=function(e){return{geometries:e.geometries,attributeLocations:e.attributeLocations,modelMatrix:e.modelMatrix,pickOffsets:e.pickOffsets,offsetInstanceExtend:e.offsetInstanceExtend,boundingSpheres:Mu(e.boundingSpheres),boundingSpheresCV:Mu(e.boundingSpheresCV)}};const yM={READY:0,CREATING:1,CREATED:2,COMBINING:3,COMBINED:4,COMPLETE:5,FAILED:6},Tt=Object.freeze(yM),_n={DISABLED:0,ENABLED:1,CAST_ONLY:2,RECEIVE_ONLY:3};_n.NUMBER_OF_SHADOW_MODES=4;_n.castShadows=function(e){return e===_n.ENABLED||e===_n.CAST_ONLY};_n.receiveShadows=function(e){return e===_n.ENABLED||e===_n.RECEIVE_ONLY};_n.fromCastReceive=function(e,t){return e&&t?_n.ENABLED:e?_n.CAST_ONLY:t?_n.RECEIVE_ONLY:_n.DISABLED};const _f=Object.freeze(_n);function rt(e){if(e=e??xe.EMPTY_OBJECT,this.geometryInstances=e.geometryInstances,this.appearance=e.appearance,this._appearance=void 0,this._material=void 0,this.depthFailAppearance=e.depthFailAppearance,this._depthFailAppearance=void 0,this._depthFailMaterial=void 0,this.modelMatrix=U.clone(e.modelMatrix??U.IDENTITY),this._modelMatrix=new U,this.show=e.show??!0,this._vertexCacheOptimize=e.vertexCacheOptimize??!1,this._interleave=e.interleave??!1,this._releaseGeometryInstances=e.releaseGeometryInstances??!0,this._allowPicking=e.allowPicking??!0,this._asynchronous=e.asynchronous??!0,this._compressVertices=e.compressVertices??!0,this.cull=e.cull??!0,this.debugShowBoundingVolume=e.debugShowBoundingVolume??!1,this.rtcCenter=e.rtcCenter,l(this.rtcCenter)&&(!l(this.geometryInstances)||Array.isArray(this.geometryInstances)&&this.geometryInstances.length!==1))throw new w("Relative-to-center rendering only supports one geometry instance.");this.shadows=e.shadows??_f.DISABLED,this._translucent=void 0,this._state=Tt.READY,this._geometries=[],this._error=void 0,this._numberOfInstances=0,this._boundingSpheres=[],this._boundingSphereWC=[],this._boundingSphereCV=[],this._boundingSphere2D=[],this._boundingSphereMorph=[],this._perInstanceAttributeCache=new Map,this._instanceIds=[],this._lastPerInstanceAttributeIndex=0,this._va=[],this._attributeLocations=void 0,this._primitiveType=void 0,this._frontFaceRS=void 0,this._backFaceRS=void 0,this._sp=void 0,this._depthFailAppearance=void 0,this._spDepthFail=void 0,this._frontFaceDepthFailRS=void 0,this._backFaceDepthFailRS=void 0,this._pickIds=[],this._colorCommands=[],this._pickCommands=[],this._createBoundingVolumeFunction=e._createBoundingVolumeFunction,this._createRenderStatesFunction=e._createRenderStatesFunction,this._createShaderProgramFunction=e._createShaderProgramFunction,this._createCommandsFunction=e._createCommandsFunction,this._updateAndQueueCommandsFunction=e._updateAndQueueCommandsFunction,this._createPickOffsets=e._createPickOffsets,this._pickOffsets=void 0,this._createGeometryResults=void 0,this._ready=!1,this._batchTable=void 0,this._batchTableAttributeIndices=void 0,this._offsetInstanceExtend=void 0,this._batchTableOffsetAttribute2DIndex=void 0,this._batchTableOffsetsUpdated=!1,this._instanceBoundingSpheres=void 0,this._instanceBoundingSpheresCV=void 0,this._tempBoundingSpheres=void 0,this._recomputeBoundingSpheres=!1,this._batchTableBoundingSpheresUpdated=!1,this._batchTableBoundingSphereAttributeIndices=void 0}Object.defineProperties(rt.prototype,{vertexCacheOptimize:{get:function(){return this._vertexCacheOptimize}},interleave:{get:function(){return this._interleave}},releaseGeometryInstances:{get:function(){return this._releaseGeometryInstances}},allowPicking:{get:function(){return this._allowPicking}},asynchronous:{get:function(){return this._asynchronous}},compressVertices:{get:function(){return this._compressVertices}},ready:{get:function(){return this._ready}}});function bM(e){const t=e.length,n=[],o=e[0].attributes;let i;for(i in o)if(o.hasOwnProperty(i)&&l(o[i])){const r=o[i];let a=!0;for(let s=1;s<t;++s){const c=e[s].attributes[i];if(!l(c)||r.componentDatatype!==c.componentDatatype||r.componentsPerAttribute!==c.componentsPerAttribute||r.normalize!==c.normalize){a=!1;break}}a&&n.push(i)}return n}const EM=new V,wM=new h,km=new Q;function jm(e){const t=e.length;if(t===1)return e[0];if(t===2)return V.unpack(e,0,EM);if(t===3)return h.unpack(e,0,wM);if(t===4)return Q.unpack(e,0,km)}function vM(e,t){const n=e.geometryInstances,o=Array.isArray(n)?n:[n],i=o.length;if(i===0)return;const r=bM(o),a=r.length,s=[],c={},f={};let d,m=o[0].attributes,_,g,y;for(_=0;_<a;++_)g=r[_],y=m[g],c[g]=_,s.push({functionName:`czm_batchTable_${g}`,componentDatatype:y.componentDatatype,componentsPerAttribute:y.componentsPerAttribute,normalize:y.normalize});r.indexOf("distanceDisplayCondition")!==-1&&(s.push({functionName:"czm_batchTable_boundingSphereCenter3DHigh",componentDatatype:ue.FLOAT,componentsPerAttribute:3},{functionName:"czm_batchTable_boundingSphereCenter3DLow",componentDatatype:ue.FLOAT,componentsPerAttribute:3},{functionName:"czm_batchTable_boundingSphereCenter2DHigh",componentDatatype:ue.FLOAT,componentsPerAttribute:3},{functionName:"czm_batchTable_boundingSphereCenter2DLow",componentDatatype:ue.FLOAT,componentsPerAttribute:3},{functionName:"czm_batchTable_boundingSphereRadius",componentDatatype:ue.FLOAT,componentsPerAttribute:1}),f.center3DHigh=s.length-5,f.center3DLow=s.length-4,f.center2DHigh=s.length-3,f.center2DLow=s.length-2,f.radius=s.length-1),r.indexOf("offset")!==-1&&(s.push({functionName:"czm_batchTable_offset2D",componentDatatype:ue.FLOAT,componentsPerAttribute:3}),d=s.length-1),s.push({functionName:"czm_batchTable_pickColor",componentDatatype:ue.UNSIGNED_BYTE,componentsPerAttribute:4,normalize:!0});const E=s.length,A=new io(t,s,i);for(_=0;_<i;++_){const S=o[_];m=S.attributes;for(let F=0;F<a;++F){g=r[F],y=m[g];const z=jm(y.value),G=c[g];A.setBatchedAttribute(_,G,z)}const O={primitive:S.pickPrimitive??e};l(S.id)&&(O.id=S.id);const M=t.createPickId(O);e._pickIds.push(M);const R=M.color,N=km;N.x=x.floatToByte(R.red),N.y=x.floatToByte(R.green),N.z=x.floatToByte(R.blue),N.w=x.floatToByte(R.alpha),A.setBatchedAttribute(_,E-1,N)}e._batchTable=A,e._batchTableAttributeIndices=c,e._batchTableBoundingSphereAttributeIndices=f,e._batchTableOffsetAttribute2DIndex=d}function TM(e){let t;return Array.isArray(e.values)?t=e.values.slice(0):t=new e.values.constructor(e.values),new Ue({componentDatatype:e.componentDatatype,componentsPerAttribute:e.componentsPerAttribute,normalize:e.normalize,values:t})}function SM(e){const t=e.attributes,n=new Kr;for(const i in t)t.hasOwnProperty(i)&&l(t[i])&&(n[i]=TM(t[i]));let o;if(l(e.indices)){const i=e.indices;Array.isArray(i)?o=i.slice(0):o=new i.constructor(i)}return new tt({attributes:n,indices:o,primitiveType:e.primitiveType,boundingSphere:ie.clone(e.boundingSphere)})}function AM(e,t){return{geometry:t,attributes:e.attributes,modelMatrix:U.clone(e.modelMatrix),pickPrimitive:e.pickPrimitive,id:e.id}}const xM=/in\s+vec(?:3|4)\s+(.*)3DHigh;/g;rt._modifyShaderPosition=function(e,t,n){let o,i="",r="",a="";for(;(o=xM.exec(t))!==null;){const s=o[1],c=`vec4 czm_compute${s[0].toUpperCase()}${s.substr(1)}()`;c!=="vec4 czm_computePosition()"&&(i+=`${c};
...
`)}function OM(e){let t=it.replaceMain(e,"czm_non_depth_clamp_main");return t+=`void main() {
    czm_non_depth_clamp_main();
    gl_Position = czm_depthClamp(gl_Position);}
`,t}function CM(e){let t=it.replaceMain(e,"czm_non_depth_clamp_main");return t+=`void main() {
    czm_non_depth_clamp_main();
    #if defined(LOG_DEPTH)
        czm_writeLogDepth();
    #else
...
`,t}function zu(e,t){const n=e.vertexAttributes;for(const o in n)if(n.hasOwnProperty(o)&&!l(t[o]))throw new w(`Appearance/Geometry mismatch.  The appearance requires vertex shader attribute input '${o}', which was not computed as part of the Geometry.  Use the appearance's vertexFormat property when constructing the geometry.`)}function MM(e,t){return function(){return e[t]}}const Pc=Math.max(xt.hardwareConcurrency-1,1);let La;const RM=new St("combineGeometry");function PM(e,t){let n,o,i,r;const a=e._instanceIds;if(e._state===Tt.READY){n=Array.isArray(e.geometryInstances)?e.geometryInstances:[e.geometryInstances];const s=e._numberOfInstances=n.length,c=[];let f=[];for(i=0;i<s;++i){if(o=n[i].geometry,a.push(n[i].id),l(o._workerName)&&l(o._workerPath)||!l(o._workerName)&&!l(o._workerPath))throw new w("Must define either _workerName or _workerPath for asynchronous geometry.");f.push({moduleName:o._workerName,modulePath:o._workerPath,geometry:o})}if(!l(La))for(La=new Array(Pc),i=0;i<Pc;i++)La[i]=new St("createGeometry");let d;for(f=JA(f,Pc),i=0;i<f.length;i++){let u=0;const m=f[i],_=m.length;for(r=0;r<_;++r)d=m[r],o=d.geometry,l(o.constructor.pack)&&(d.offset=u,u+=o.constructor.packedLength??o.packedLength);let g;if(u>0){const y=new Float64Array(u);for(g=[y.buffer],r=0;r<_;++r)d=m[r],o=d.geometry,l(o.constructor.pack)&&(o.constructor.pack(o,y,d.offset),d.geometry=y)}c.push(La[i].scheduleTask({subTasks:f[i]},g))}e._state=Tt.CREATING,Promise.all(c).then(function(u){e._createGeometryResults=u,e._state=Tt.CREATED}).catch(function(u){Or(e,t,Tt.FAILED,u)})}else if(e._state===Tt.CREATED){const s=[];n=Array.isArray(e.geometryInstances)?e.geometryInstances:[e.geometryInstances];const c=t.scene3DOnly,f=t.mapProjection,d=RM.scheduleTask(kn.packCombineGeometryParameters({createGeometryResults:e._createGeometryResults,instances:n,ellipsoid:f.ellipsoid,projection:f,elementIndexUintSupported:t.context.elementIndexUint,scene3DOnly:c,vertexCacheOptimize:e.vertexCacheOptimize,compressVertices:e.compressVertices,modelMatrix:e.modelMatrix,createPickOffsets:e._createPickOffsets},s),s);e._createGeometryResults=void 0,e._state=Tt.COMBINING,Promise.resolve(d).then(function(u){const m=kn.unpackCombineGeometryResults(u);e._geometries=m.geometries,e._attributeLocations=m.attributeLocations,e.modelMatrix=U.clone(m.modelMatrix,e.modelMatrix),e._pickOffsets=m.pickOffsets,e._offsetInstanceExtend=m.offsetInstanceExtend,e._instanceBoundingSpheres=m.boundingSpheres,e._instanceBoundingSpheresCV=m.boundingSpheresCV,l(e._geometries)&&e._geometries.length>0?(e._recomputeBoundingSpheres=!0,e._state=Tt.COMBINED):Or(e,t,Tt.FAILED,void 0)}).catch(function(u){Or(e,t,Tt.FAILED,u)})}}function IM(e,t){const n=Array.isArray(e.geometryInstances)?e.geometryInstances:[e.geometryInstances],o=e._numberOfInstances=n.length,i=new Array(o),r=e._instanceIds;let a,s,c=0;for(s=0;s<o;s++){a=n[s];const m=a.geometry;let _;l(m.attributes)&&l(m.primitiveType)?_=SM(m):_=m.constructor.createGeometry(m),i[c++]=AM(a,_),r.push(a.id)}i.length=c;const f=t.scene3DOnly,d=t.mapProjection,u=kn.combineGeometry({instances:i,ellipsoid:d.ellipsoid,projection:d,elementIndexUintSupported:t.context.elementIndexUint,scene3DOnly:f,vertexCacheOptimize:e.vertexCacheOptimize,compressVertices:e.compressVertices,modelMatrix:e.modelMatrix,createPickOffsets:e._createPickOffsets});e._geometries=u.geometries,e._attributeLocations=u.attributeLocations,e.modelMatrix=U.clone(u.modelMatrix,e.modelMatrix),e._pickOffsets=u.pickOffsets,e._offsetInstanceExtend=u.offsetInstanceExtend,e._instanceBoundingSpheres=u.boundingSpheres,e._instanceBoundingSpheresCV=u.boundingSpheresCV,l(e._geometries)&&e._geometries.length>0?(e._recomputeBoundingSpheres=!0,e._state=Tt.COMBINED):Or(e,t,Tt.FAILED,void 0)}function zM(e,t){const n=e._batchTableAttributeIndices.offset;if(!e._recomputeBoundingSpheres||!l(n)){e._recomputeBoundingSpheres=!1;return}let o;const i=e._offsetInstanceExtend,r=e._instanceBoundingSpheres,a=r.length;let s=e._tempBoundingSpheres;if(!l(s)){for(s=new Array(a),o=0;o<a;o++)s[o]=new ie;e._tempBoundingSpheres=s}for(o=0;o<a;++o){let y=s[o];const E=e._batchTable.getBatchedAttribute(o,n,new h);y=r[o].clone(y),Ym(y,E,i[o])}const c=[],f=[],d=[];for(o=0;o<a;++o){const y=s[o];y.center.x-y.radius>0||ie.intersectPlane(y,De.ORIGIN_ZX_PLANE)!==bt.INTERSECTING?c.push(y):(f.push(y),d.push(y))}let u=c[0],m=d[0],_=f[0];for(o=1;o<c.length;o++)u=ie.union(u,c[o]);for(o=1;o<d.length;o++)m=ie.union(m,d[o]);for(o=1;o<f.length;o++)_=ie.union(_,f[o]);const g=[];for(l(u)&&g.push(u),l(m)&&g.push(m),l(_)&&g.push(_),o=0;o<g.length;o++){const y=g[o].clone(e._boundingSpheres[o]);e._boundingSpheres[o]=y,e._boundingSphereCV[o]=ie.projectTo2D(y,t.mapProjection,e._boundingSphereCV[o])}rt._updateBoundingVolumes(e,t,e.modelMatrix,!0),e._recomputeBoundingSpheres=!1}const Nu=new at,Vm=new le,Hm=new h,Wm=new ie;function NM(e,t){if(!l(e._batchTableAttributeIndices.distanceDisplayCondition)||e._batchTableBoundingSpheresUpdated)return;const o=e._batchTableBoundingSphereAttributeIndices,i=o.center3DHigh,r=o.center3DLow,a=o.center2DHigh,s=o.center2DLow,c=o.radius,f=t.mapProjection,d=f.ellipsoid,u=e._batchTable,m=e._instanceBoundingSpheres,_=m.length;for(let g=0;g<_;++g){let y=m[g];if(!l(y))continue;const E=e.modelMatrix;l(E)&&(y=ie.transform(y,E,Wm));const A=y.center,S=y.radius;let O=at.fromCartesian(A,Nu);if(u.setBatchedAttribute(g,i,O.high),u.setBatchedAttribute(g,r,O.low),!t.scene3DOnly){const M=d.cartesianToCartographic(A,Vm),R=f.project(M,Hm);O=at.fromCartesian(R,Nu),u.setBatchedAttribute(g,a,O.high),u.setBatchedAttribute(g,s,O.low)}u.setBatchedAttribute(g,c,S)}e._batchTableBoundingSpheresUpdated=!0}const Ic=new h,DM=new h;function Du(e,t){if(!l(e._batchTableAttributeIndices.offset)||e._batchTableOffsetsUpdated||t.scene3DOnly)return;const o=e._batchTableOffsetAttribute2DIndex,i=t.mapProjection,r=i.ellipsoid,a=e._batchTable,s=e._instanceBoundingSpheres,c=s.length;for(let f=0;f<c;++f){let d=s[f];if(!l(d))continue;const u=a.getBatchedAttribute(f,e._batchTableAttributeIndices.offset);if(h.equals(u,h.ZERO)){a.setBatchedAttribute(f,o,h.ZERO);continue}const m=e.modelMatrix;l(m)&&(d=ie.transform(d,m,Wm));let _=d.center;_=r.scaleToGeodeticSurface(_,DM);let g=r.cartesianToCartographic(_,Vm);const y=i.project(g,Hm),E=h.add(u,_,Ic);g=r.cartesianToCartographic(E,g);const A=i.project(g,Ic),S=h.subtract(A,y,Ic),O=S.x;S.x=S.z,S.z=S.y,S.y=O,a.setBatchedAttribute(f,o,S)}e._batchTableOffsetsUpdated=!0}function LM(e,t){const n=e._attributeLocations,o=e._geometries,i=t.scene3DOnly,r=t.context,a=[],s=o.length;for(let c=0;c<s;++c){const f=o[c];if(a.push(qn.fromGeometry({context:r,geometry:f,attributeLocations:n,bufferUsage:Ln.STATIC_DRAW,interleave:e._interleave})),l(e._createBoundingVolumeFunction))e._createBoundingVolumeFunction(t,f);else if(e._boundingSpheres.push(ie.clone(f.boundingSphere)),e._boundingSphereWC.push(new ie),!i){const d=f.boundingSphereCV.center,u=d.x,m=d.y,_=d.z;d.x=_,d.y=u,d.z=m,e._boundingSphereCV.push(ie.clone(f.boundingSphereCV)),e._boundingSphere2D.push(new ie),e._boundingSphereMorph.push(new ie)}}e._va=a,e._primitiveType=o[0].primitiveType,e.releaseGeometryInstances&&(e.geometryInstances=void 0),e._geometries=void 0,Or(e,t,Tt.COMPLETE,void 0)}function FM(e,t,n,o){let i=n.getRenderState(),r;o?(r=en(i,!1),r.cull={enabled:!0,face:gr.BACK},e._frontFaceRS=Ut.fromCache(r),r.cull.face=gr.FRONT,e._backFaceRS=Ut.fromCache(r)):(e._frontFaceRS=Ut.fromCache(i),e._backFaceRS=e._frontFaceRS),r=en(i,!1),l(e._depthFailAppearance)&&(r.depthTest.enabled=!1),l(e._depthFailAppearance)&&(i=e._depthFailAppearance.getRenderState(),r=en(i,!1),r.depthTest.func=X3.GREATER,o?(r.cull={enabled:!0,face:gr.BACK},e._frontFaceDepthFailRS=Ut.fromCache(r),r.cull.face=gr.FRONT,e._backFaceDepthFailRS=Ut.fromCache(r)):(e._frontFaceDepthFailRS=Ut.fromCache(r),e._backFaceDepthFailRS=e._frontFaceRS))}function BM(e,t,n){const o=t.context,i=e._attributeLocations;let r=e._batchTable.getVertexShaderCallback()(n.vertexShaderSource);r=rt._appendOffsetToShader(e,r),r=rt._appendShowToShader(e,r),r=rt._appendDistanceDisplayConditionToShader(e,r,t.scene3DOnly),r=Ru(r),r=rt._updateColorAttribute(e,r,!1),r=Iu(e,r),r=rt._modifyShaderPosition(e,r,t.scene3DOnly);let a=n.getFragmentShaderSource();a=Pu(a),e._sp=Gn.replaceCache({context:o,shaderProgram:e._sp,vertexShaderSource:r,fragmentShaderSource:a,attributeLocations:i}),zu(e._sp,i),l(e._depthFailAppearance)&&(r=e._batchTable.getVertexShaderCallback()(e._depthFailAppearance.vertexShaderSource),r=rt._appendShowToShader(e,r),r=rt._appendDistanceDisplayConditionToShader(e,r,t.scene3DOnly),r=Ru(r),r=rt._updateColorAttribute(e,r,!0),r=Iu(e,r),r=rt._modifyShaderPosition(e,r,t.scene3DOnly),r=OM(r),a=e._depthFailAppearance.getFragmentShaderSource(),a=Pu(a),a=CM(a),e._spDepthFail=Gn.replaceCache({context:o,shaderProgram:e._spDepthFail,vertexShaderSource:r,fragmentShaderSource:a,attributeLocations:i}),zu(e._spDepthFail,i))}const fr=new U,Lu=new h;function Fu(e,t,n,o){const i=l(n)?n._uniforms:void 0,r={},a=t.uniforms;if(l(a)){for(const c in a)if(a.hasOwnProperty(c)){if(l(i)&&l(i[c]))throw new w(`Appearance and material have a uniform with the same name: ${c}`);r[c]=MM(a,c)}}let s=nn(r,i);return s=e._batchTable.getUniformMapCallback()(s),l(e.rtcCenter)&&(s.u_modifiedModelView=function(){const c=o.context.uniformState.view;return U.multiply(c,e._modelMatrix,fr),U.multiplyByPoint(fr,e.rtcCenter,Lu),U.setTranslation(fr,Lu,fr),fr}),s}function UM(e,t,n,o,i,r,a,s){const c=Fu(e,t,n,s);let f;l(e._depthFailAppearance)&&(f=Fu(e,e._depthFailAppearance,e._depthFailAppearance.material,s));const d=o?Ci.TRANSLUCENT:Ci.OPAQUE;let u=i?2:1;u*=l(e._depthFailAppearance)?2:1,r.length=e._va.length*u;const m=r.length;let _=0;for(let g=0;g<m;++g){let y;i&&(y=r[g],l(y)||(y=r[g]=new Kn({owner:e,primitiveType:e._primitiveType})),y.vertexArray=e._va[_],y.renderState=e._backFaceRS,y.shaderProgram=e._sp,y.uniformMap=c,y.pass=d,++g),y=r[g],l(y)||(y=r[g]=new Kn({owner:e,primitiveType:e._primitiveType})),y.vertexArray=e._va[_],y.renderState=e._frontFaceRS,y.shaderProgram=e._sp,y.uniformMap=c,y.pass=d,l(e._depthFailAppearance)&&(i&&(++g,y=r[g],l(y)||(y=r[g]=new Kn({owner:e,primitiveType:e._primitiveType})),y.vertexArray=e._va[_],y.renderState=e._backFaceDepthFailRS,y.shaderProgram=e._spDepthFail,y.uniformMap=f,y.pass=d),++g,y=r[g],l(y)||(y=r[g]=new Kn({owner:e,primitiveType:e._primitiveType})),y.vertexArray=e._va[_],y.renderState=e._frontFaceDepthFailRS,y.shaderProgram=e._spDepthFail,y.uniformMap=f,y.pass=d),++_}}rt._updateBoundingVolumes=function(e,t,n,o){let i,r,a;if(o||!U.equals(n,e._modelMatrix))for(U.clone(n,e._modelMatrix),r=e._boundingSpheres.length,i=0;i<r;++i)a=e._boundingSpheres[i],l(a)&&(e._boundingSphereWC[i]=ie.transform(a,n,e._boundingSphereWC[i]),t.scene3DOnly||(e._boundingSphere2D[i]=ie.clone(e._boundingSphereCV[i],e._boundingSphere2D[i]),e._boundingSphereMorph[i]=ie.union(e._boundingSphereWC[i],e._boundingSphereCV[i])));const s=e.appearance.pixelSize;if(l(s))for(r=e._boundingSpheres.length,i=0;i<r;++i){a=e._boundingSpheres[i];const c=e._boundingSphereWC[i],d=t.camera.getPixelSize(a,t.context.drawingBufferWidth,t.context.drawingBufferHeight)*s;c.radius=a.radius+d}};function GM(e,t,n,o,i,r,a,s){if(t.mode!==st.SCENE3D&&!U.equals(i,U.IDENTITY))throw new w("Primitive.modelMatrix is only supported in 3D mode.");rt._updateBoundingVolumes(e,t,i);let c;t.mode===st.SCENE3D?c=e._boundingSphereWC:t.mode===st.COLUMBUS_VIEW?c=e._boundingSphereCV:t.mode===st.SCENE2D&&l(e._boundingSphere2D)?c=e._boundingSphere2D:l(e._boundingSphereMorph)&&(c=e._boundingSphereMorph);const f=t.commandList,d=t.passes;if(d.render||d.pick){const u=e.allowPicking,m=_f.castShadows(e.shadows),_=_f.receiveShadows(e.shadows),g=n.length;let y=s?2:1;y*=l(e._depthFailAppearance)?2:1;for(let E=0;E<g;++E){const A=Math.floor(E/y),S=n[E];S.modelMatrix=i,S.boundingVolume=c[A],S.cull=r,S.debugShowBoundingVolume=a,S.castShadows=m,S.receiveShadows=_,u?S.pickId="v_pickColor":S.pickId=void 0,f.push(S)}}}rt.prototype.update=function(e){if(!l(this.geometryInstances)&&this._va.length===0||l(this.geometryInstances)&&Array.isArray(this.geometryInstances)&&this.geometryInstances.length===0||!l(this.appearance)||e.mode!==st.SCENE3D&&e.scene3DOnly||!e.passes.render&&!e.passes.pick)return;if(l(this._error))throw this._error;if(l(this.rtcCenter)&&!e.scene3DOnly)throw new w("RTC rendering is only available for 3D only scenes.");if(this._state===Tt.FAILED)return;const t=e.context;if(l(this._batchTable)||vM(this,t),this._batchTable.attributes.length>0){if(Ie.maximumVertexTextureImageUnits===0)throw new mt("Vertex texture fetch support is required to render primitives with per-instance attributes. The maximum number of vertex texture image units must be greater than zero.");this._batchTable.update(e)}if(this._state!==Tt.COMPLETE&&this._state!==Tt.COMBINED&&(this.asynchronous?PM(this,e):IM(this,e)),this._state===Tt.COMBINED&&(NM(this,e),Du(this,e),LM(this,e)),!this.show||this._state!==Tt.COMPLETE)return;this._batchTableOffsetsUpdated||Du(this,e),this._recomputeBoundingSpheres&&zM(this,e);const n=this.appearance,o=n.material;let i=!1,r=!1;this._appearance!==n?(this._appearance=n,this._material=o,i=!0,r=!0):this._material!==o&&(this._material=o,r=!0);const a=this.depthFailAppearance,s=l(a)?a.material:void 0;this._depthFailAppearance!==a?(this._depthFailAppearance=a,this._depthFailMaterial=s,i=!0,r=!0):this._depthFailMaterial!==s&&(this._depthFailMaterial=s,r=!0);const c=this._appearance.isTranslucent();this._translucent!==c&&(this._translucent=c,i=!0),l(this._material)&&this._material.update(t);const f=n.closed&&c;i&&(this._createRenderStatesFunction??FM)(this,t,n,f),r&&(this._createShaderProgramFunction??BM)(this,e,n),(i||r)&&(this._createCommandsFunction??UM)(this,n,o,c,f,this._colorCommands,this._pickCommands,e),(this._updateAndQueueCommandsFunction??GM)(this,e,this._colorCommands,this._pickCommands,this.modelMatrix,this.cull,this.debugShowBoundingVolume,f)};const qM=new ie,kM=new ie;function Ym(e,t,n){if(n===ds.TOP){const o=ie.clone(e,qM),i=ie.clone(e,kM);i.center=h.add(i.center,t,i.center),e=ie.union(o,i,e)}else n===ds.ALL&&(e.center=h.add(e.center,t,e.center));return e}function jM(e,t,n){return function(){const o=e.getBatchedAttribute(t,n),i=e.attributes[n],r=i.componentsPerAttribute,a=ue.createTypedArray(i.componentDatatype,r);return l(o.constructor.pack)?o.constructor.pack(o,a,0):a[0]=o,a}}function VM(e,t,n,o,i){return function(r){if(!l(r)||!l(r.length)||r.length<1||r.length>4)throw new w("value must be and array with length between 1 and 4.");const a=jm(r);e.setBatchedAttribute(t,n,a),i==="offset"&&(o._recomputeBoundingSpheres=!0,o._batchTableOffsetsUpdated=!1)}}const HM=new h;function WM(e,t,n){t.boundingSphere={get:function(){let o=e._instanceBoundingSpheres[n];if(l(o)){o=o.clone();const i=e.modelMatrix,r=t.offset;l(r)&&Ym(o,h.fromArray(r.get(),0,HM),e._offsetInstanceExtend[n]),l(i)&&(o=ie.transform(o,i))}return o}},t.boundingSphereCV={get:function(){return e._instanceBoundingSpheresCV[n]}}}function YM(e,t,n){t.pickId={get:function(){return e._pickIds[n]}}}rt.prototype.getGeometryInstanceAttributes=function(e){if(!l(e))throw new w("id is required");if(!l(this._batchTable))throw new w("must call update before calling getGeometryInstanceAttributes");let t=this._perInstanceAttributeCache.get(e);if(l(t))return t;let n=-1;const o=this._lastPerInstanceAttributeIndex,i=this._instanceIds,r=i.length;for(let f=0;f<r;++f){const d=(o+f)%r;if(e===i[d]){n=d;break}}if(n===-1)return;const a=this._batchTable,s=this._batchTableAttributeIndices;t={};const c={};for(const f in s)if(s.hasOwnProperty(f)){const d=s[f];c[f]={get:jM(a,n,d),set:VM(a,n,d,this,f)}}return WM(this,c,n),YM(this,c,n),Object.defineProperties(t,c),this._lastPerInstanceAttributeIndex=n,this._perInstanceAttributeCache.set(e,t),t};rt.prototype.isDestroyed=function(){return!1};rt.prototype.destroy=function(){let e,t;this._sp=this._sp&&this._sp.destroy(),this._spDepthFail=this._spDepthFail&&this._spDepthFail.destroy();const n=this._va;for(e=n.length,t=0;t<e;++t)n[t].destroy();this._va=void 0;const o=this._pickIds;for(e=o.length,t=0;t<e;++t)o[t].destroy();return this._pickIds=void 0,this._batchTable=this._batchTable&&this._batchTable.destroy(),this._instanceIds=void 0,this._perInstanceAttributeCache=void 0,this._attributeLocations=void 0,Ft(this)};function Or(e,t,n,o){e._error=o,e._state=n,t.afterRender.push(function(){return e._ready=e._state===Tt.COMPLETE||e._state===Tt.FAILED,!0})}const $M=`void clipLineSegmentToNearPlane(
    vec3 p0,
    vec3 p1,
    out vec4 positionWC,
    out bool clipped,
...
`;function Ot(e,t){e=e??xe.EMPTY_OBJECT,this._show=e.show??!0,this._width=e.width??1,this._loop=e.loop??!1,this._distanceDisplayCondition=e.distanceDisplayCondition,this._material=e.material,l(this._material)||(this._material=ee.fromType(ee.ColorType,{color:new x(1,1,1,1)}));let n=e.positions;l(n)||(n=[]),this._positions=n,this._actualPositions=oi(n,h.equalsEpsilon),this._loop&&this._actualPositions.length>2&&(this._actualPositions===this._positions&&(this._actualPositions=n.slice()),this._actualPositions.push(h.clone(this._actualPositions[0]))),this._length=this._actualPositions.length,this._id=e.id;let o;l(t)&&(o=U.clone(t.modelMatrix)),this._modelMatrix=o,this._segments=Zt.wrapLongitude(this._actualPositions,o),this._actualLength=void 0,this._propertiesChanged=new Uint32Array(Xm),this._polylineCollection=t,this._dirty=!1,this._pickId=void 0,this._boundingVolume=ie.fromPoints(this._actualPositions),this._boundingVolumeWC=ie.transform(this._boundingVolume,this._modelMatrix),this._boundingVolume2D=new ie}const $m=Ot.POSITION_INDEX=0,KM=Ot.SHOW_INDEX=1,QM=Ot.WIDTH_INDEX=2,JM=Ot.MATERIAL_INDEX=3,Cr=Ot.POSITION_SIZE_INDEX=4,eR=Ot.DISTANCE_DISPLAY_CONDITION=5,Xm=Ot.NUMBER_OF_PROPERTIES=6;function fo(e,t){++e._propertiesChanged[t];const n=e._polylineCollection;l(n)&&(n._updatePolyline(e,t),e._dirty=!0)}Object.defineProperties(Ot.prototype,{show:{get:function(){return this._show},set:function(e){if(!l(e))throw new w("value is required.");e!==this._show&&(this._show=e,fo(this,KM))}},positions:{get:function(){return this._positions},set:function(e){if(!l(e))throw new w("value is required.");let t=oi(e,h.equalsEpsilon);this._loop&&t.length>2&&(t===e&&(t=e.slice()),t.push(h.clone(t[0]))),(this._actualPositions.length!==t.length||this._actualPositions.length!==this._length)&&fo(this,Cr),this._positions=e,this._actualPositions=t,this._length=t.length,this._boundingVolume=ie.fromPoints(this._actualPositions,this._boundingVolume),this._boundingVolumeWC=ie.transform(this._boundingVolume,this._modelMatrix,this._boundingVolumeWC),fo(this,$m),this.update()}},material:{get:function(){return this._material},set:function(e){if(!l(e))throw new w("material is required.");this._material!==e&&(this._material=e,fo(this,JM))}},width:{get:function(){return this._width},set:function(e){if(!l(e))throw new w("value is required.");const t=this._width;e!==t&&(this._width=e,fo(this,QM))}},loop:{get:function(){return this._loop},set:function(e){if(!l(e))throw new w("value is required.");if(e!==this._loop){let t=this._actualPositions;e?t.length>2&&!h.equals(t[0],t[t.length-1])&&(t.length===this._positions.length&&(this._actualPositions=t=this._positions.slice()),t.push(h.clone(t[0]))):t.length>2&&h.equals(t[0],t[t.length-1])&&(t.length-1===this._positions.length?this._actualPositions=this._positions:t.pop()),this._loop=e,fo(this,Cr)}}},id:{get:function(){return this._id},set:function(e){this._id=e,l(this._pickId)&&(this._pickId.object.id=e)}},pickId:{get:function(){return this._pickId}},isDestroyed:{get:function(){return!l(this._polylineCollection)}},distanceDisplayCondition:{get:function(){return this._distanceDisplayCondition},set:function(e){if(l(e)&&e.far<=e.near)throw new w("far distance must be greater than near distance.");ln.equals(e,this._distanceDisplayCondition)||(this._distanceDisplayCondition=ln.clone(e,this._distanceDisplayCondition),fo(this,eR))}}});Ot.prototype.update=function(){let e=U.IDENTITY;l(this._polylineCollection)&&(e=this._polylineCollection.modelMatrix);const t=this._segments.positions.length,n=this._segments.lengths,o=this._propertiesChanged[$m]>0||this._propertiesChanged[Cr]>0;if((!U.equals(e,this._modelMatrix)||o)&&(this._segments=Zt.wrapLongitude(this._actualPositions,e),this._boundingVolumeWC=ie.transform(this._boundingVolume,e,this._boundingVolumeWC)),this._modelMatrix=U.clone(e,this._modelMatrix),this._segments.positions.length!==t)fo(this,Cr);else{const i=n.length;for(let r=0;r<i;++r)if(n[r]!==this._segments.lengths[r]){fo(this,Cr);break}}};Ot.prototype.getPickId=function(e){return l(this._pickId)||(this._pickId=e.createPickId({primitive:this,collection:this._polylineCollection,id:this._id})),this._pickId};Ot.prototype._clean=function(){this._dirty=!1;const e=this._propertiesChanged;for(let t=0;t<Xm-1;++t)e[t]=0};Ot.prototype._destroy=function(){this._pickId=this._pickId&&this._pickId.destroy(),this._material=this._material&&this._material.destroy(),this._polylineCollection=void 0};const tR=Ot.SHOW_INDEX,nR=Ot.WIDTH_INDEX,gf=Ot.POSITION_INDEX,oR=Ot.MATERIAL_INDEX,Bu=Ot.POSITION_SIZE_INDEX,iR=Ot.DISTANCE_DISPLAY_CONDITION,Zm=Ot.NUMBER_OF_PROPERTIES,rn={texCoordExpandAndBatchIndex:0,position3DHigh:1,position3DLow:2,position2DHigh:3,position2DLow:4,prevPosition3DHigh:5,prevPosition3DLow:6,prevPosition2DHigh:7,prevPosition2DLow:8,nextPosition3DHigh:9,nextPosition3DLow:10,nextPosition2DHigh:11,nextPosition2DLow:12};function Vn(e){e=e??xe.EMPTY_OBJECT,this.show=e.show??!0,this.modelMatrix=U.clone(e.modelMatrix??U.IDENTITY),this._modelMatrix=U.clone(U.IDENTITY),this.debugShowBoundingVolume=e.debugShowBoundingVolume??!1,this._opaqueRS=void 0,this._translucentRS=void 0,this._colorCommands=[],this._polylinesUpdated=!1,this._polylinesRemoved=!1,this._createVertexArray=!1,this._propertiesChanged=new Uint32Array(Zm),this._polylines=[],this._polylineBuckets={},this._positionBufferUsage={bufferUsage:Ln.STATIC_DRAW,frameCount:0},this._mode=void 0,this._polylinesToUpdate=[],this._vertexArrays=[],this._positionBuffer=void 0,this._texCoordExpandAndBatchIndexBuffer=void 0,this._batchTable=void 0,this._createBatchTable=!1,this._useHighlightColor=!1,this._highlightColor=x.clone(x.WHITE);const t=this;this._uniformMap={u_highlightColor:function(){return t._highlightColor}}}Object.defineProperties(Vn.prototype,{length:{get:function(){return hh(this),this._polylines.length}}});Vn.prototype.add=function(e){const t=new Ot(e,this);return t._index=this._polylines.length,this._polylines.push(t),this._createVertexArray=!0,this._createBatchTable=!0,t};Vn.prototype.remove=function(e){if(this.contains(e)){if(this._polylinesRemoved=!0,this._createVertexArray=!0,this._createBatchTable=!0,l(e._bucket)){const t=e._bucket;t.shaderProgram=t.shaderProgram&&t.shaderProgram.destroy()}return e._destroy(),!0}return!1};Vn.prototype.removeAll=function(){lh(this),tp(this),this._polylineBuckets={},this._polylinesRemoved=!1,this._polylines.length=0,this._polylinesToUpdate.length=0,this._createVertexArray=!0};Vn.prototype.contains=function(e){return l(e)&&e._polylineCollection===this};Vn.prototype.get=function(e){if(!l(e))throw new w("index is required.");return hh(this),this._polylines[e]};function rR(e,t){l(e._batchTable)&&e._batchTable.destroy();const n=[{functionName:"batchTable_getWidthAndShow",componentDatatype:ue.UNSIGNED_BYTE,componentsPerAttribute:2},{functionName:"batchTable_getPickColor",componentDatatype:ue.UNSIGNED_BYTE,componentsPerAttribute:4,normalize:!0},{functionName:"batchTable_getCenterHigh",componentDatatype:ue.FLOAT,componentsPerAttribute:3},{functionName:"batchTable_getCenterLowAndRadius",componentDatatype:ue.FLOAT,componentsPerAttribute:4},{functionName:"batchTable_getDistanceDisplayCondition",componentDatatype:ue.FLOAT,componentsPerAttribute:2}];e._batchTable=new io(t,n,e._polylines.length)}const Km=new at,Qm=new Q,Jm=new V;Vn.prototype.update=function(e){if(hh(this),this._polylines.length===0||!this.show)return;lR(this,e);const t=e.context,n=e.mapProjection;let o,i=this._propertiesChanged;if(this._createBatchTable){if(Ie.maximumVertexTextureImageUnits===0)throw new mt("Vertex texture fetch support is required to render polylines. The maximum number of vertex texture image units must be greater than zero.");rR(this,t),this._createBatchTable=!1}if(this._createVertexArray||sR(this))qu(this,t,n);else if(this._polylinesUpdated){const c=this._polylinesToUpdate;if(this._mode!==st.SCENE3D){const f=c.length;for(let d=0;d<f;++d)o=c[d],o.update()}if(i[Bu]||i[oR])qu(this,t,n);else{const f=c.length,d=this._polylineBuckets;for(let u=0;u<f;++u){o=c[u],i=o._propertiesChanged;const m=o._bucket;let _=0;for(const g in d)if(d.hasOwnProperty(g)){if(d[g]===m){i[gf]&&m.writeUpdate(_,o,this._positionBuffer,n);break}_+=d[g].lengthOfPositions}if((i[tR]||i[nR])&&this._batchTable.setBatchedAttribute(o._index,0,new V(o._width,o._show)),this._batchTable.attributes.length>2){if(i[gf]||i[Bu]){const g=e.mode===st.SCENE2D?o._boundingVolume2D:o._boundingVolumeWC,y=at.fromCartesian(g.center,Km),E=Q.fromElements(y.low.x,y.low.y,y.low.z,g.radius,Qm);this._batchTable.setBatchedAttribute(o._index,2,y.high),this._batchTable.setBatchedAttribute(o._index,3,E)}if(i[iR]){const g=Jm;g.x=0,g.y=Number.MAX_VALUE;const y=o.distanceDisplayCondition;l(y)&&(g.x=y.near,g.y=y.far),this._batchTable.setBatchedAttribute(o._index,4,g)}}o._clean()}}c.length=0,this._polylinesUpdated=!1}i=this._propertiesChanged;for(let c=0;c<Zm;++c)i[c]=0;let r=U.IDENTITY;e.mode===st.SCENE3D&&(r=this.modelMatrix);const a=e.passes,s=e.morphTime!==0;if((!l(this._opaqueRS)||this._opaqueRS.depthTest.enabled!==s)&&(this._opaqueRS=Ut.fromCache({depthMask:s,depthTest:{enabled:s}})),(!l(this._translucentRS)||this._translucentRS.depthTest.enabled!==s)&&(this._translucentRS=Ut.fromCache({blending:fh.ALPHA_BLEND,depthMask:!s,depthTest:{enabled:s}})),this._batchTable.update(e),a.render||a.pick){const c=this._colorCommands;aR(this,e,c,r)}};const hr=new ie,Uu=new ie;function aR(e,t,n,o){const i=t.context,r=t.commandList,a=n.length;let s=0,c=!0;const f=e._vertexArrays,d=e.debugShowBoundingVolume,m=e._batchTable.getUniformMapCallback(),_=f.length;for(let g=0;g<_;++g){const y=f[g],E=y.buckets,A=E.length;for(let S=0;S<A;++S){const O=E[S];let M=O.offset;const R=O.bucket.shaderProgram,N=O.bucket.polylines,F=N.length;let z,G,q=0,k,X;for(let b=0;b<F;++b){const v=N[b],C=fR(v._material);if(C!==z){if(l(z)&&q>0){const J=G.isTranslucent();s>=a?(k=new Kn({owner:e}),n.push(k)):k=n[s],++s,X=nn(m(G._uniforms),e._uniformMap),k.boundingVolume=ie.clone(hr,k.boundingVolume),k.modelMatrix=o,k.shaderProgram=R,k.vertexArray=y.va,k.renderState=J?e._translucentRS:e._opaqueRS,k.pass=J?Ci.TRANSLUCENT:Ci.OPAQUE,k.debugShowBoundingVolume=d,k.pickId="v_pickColor",k.uniformMap=X,k.count=q,k.offset=M,M+=q,q=0,c=!0,r.push(k)}G=v._material,G.update(i),z=C}const D=v._locatorBuckets,H=D.length;for(let J=0;J<H;++J){const K=D[J];K.locator===O&&(q+=K.count)}let Z;t.mode===st.SCENE3D?Z=v._boundingVolumeWC:t.mode===st.COLUMBUS_VIEW?Z=v._boundingVolume2D:t.mode===st.SCENE2D?l(v._boundingVolume2D)&&(Z=ie.clone(v._boundingVolume2D,Uu),Z.center.x=0):l(v._boundingVolumeWC)&&l(v._boundingVolume2D)&&(Z=ie.union(v._boundingVolumeWC,v._boundingVolume2D,Uu)),c?(c=!1,ie.clone(Z,hr)):ie.union(Z,hr,hr)}l(z)&&q>0&&(s>=a?(k=new Kn({owner:e}),n.push(k)):k=n[s],++s,X=nn(m(G._uniforms),e._uniformMap),k.boundingVolume=ie.clone(hr,k.boundingVolume),k.modelMatrix=o,k.shaderProgram=R,k.vertexArray=y.va,k.renderState=G.isTranslucent()?e._translucentRS:e._opaqueRS,k.pass=G.isTranslucent()?Ci.TRANSLUCENT:Ci.OPAQUE,k.debugShowBoundingVolume=d,k.pickId="v_pickColor",k.uniformMap=X,k.count=q,k.offset=M,c=!0,r.push(k)),z=void 0}}n.length=s}Vn.prototype.isDestroyed=function(){return!1};Vn.prototype.destroy=function(){return ep(this),lh(this),tp(this),this._batchTable=this._batchTable&&this._batchTable.destroy(),Ft(this)};function sR(e){let t=!1;const n=e._propertiesChanged,o=e._positionBufferUsage;return n[gf]?(o.bufferUsage!==Ln.STREAM_DRAW&&(t=!0,o.bufferUsage=Ln.STREAM_DRAW),o.frameCount=100):o.bufferUsage!==Ln.STATIC_DRAW&&(o.frameCount===0?(t=!0,o.bufferUsage=Ln.STATIC_DRAW):o.frameCount--),t}const Gu=[0,0,0];function qu(e,t,n){e._createVertexArray=!1,lh(e),ep(e),hR(e);const o=[[]];let i=o[0];const r=e._batchTable,a=e._useHighlightColor,s=[0];let c=0;const f=[[]];let d=0;const u=e._polylineBuckets;let m,_;for(m in u)u.hasOwnProperty(m)&&(_=u[m],_.updateShader(t,r,a),d+=_.lengthOfPositions);if(d>0){const g=e._mode,y=new Float32Array(6*d*3),E=new Float32Array(d*4);let A,S=0,O=0,M=0;for(m in u)if(u.hasOwnProperty(m)){_=u[m],_.write(y,E,S,O,M,r,t,n),g===st.MORPHING&&(l(A)||(A=new Float32Array(6*d*3)),_.writeForMorph(A,S));const X=_.lengthOfPositions;S+=6*X*3,O+=X*4,M+=X*4,c=_.updateIndices(o,s,f,c)}const R=e._positionBufferUsage.bufferUsage,N=Ln.STATIC_DRAW;e._positionBuffer=At.createVertexBuffer({context:t,typedArray:y,usage:R});let F;l(A)&&(F=At.createVertexBuffer({context:t,typedArray:A,usage:R})),e._texCoordExpandAndBatchIndexBuffer=At.createVertexBuffer({context:t,typedArray:E,usage:N});const z=3*Float32Array.BYTES_PER_ELEMENT,G=4*Float32Array.BYTES_PER_ELEMENT;let q=0;const k=o.length;for(let X=0;X<k;++X)if(i=o[X],i.length>0){const b=new Uint16Array(i),v=At.createIndexBuffer({context:t,typedArray:b,usage:Ln.STATIC_DRAW,indexDatatype:gt.UNSIGNED_SHORT});q+=s[X];const C=6*(X*(z*T.SIXTY_FOUR_KILOBYTES)-q*z),D=z+C,H=z+D,Z=z+H,J=z+Z,K=z+J,te=X*(G*T.SIXTY_FOUR_KILOBYTES)-q*G,he=[{index:rn.position3DHigh,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:C,strideInBytes:6*z},{index:rn.position3DLow,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:D,strideInBytes:6*z},{index:rn.position2DHigh,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:C,strideInBytes:6*z},{index:rn.position2DLow,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:D,strideInBytes:6*z},{index:rn.prevPosition3DHigh,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:H,strideInBytes:6*z},{index:rn.prevPosition3DLow,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:Z,strideInBytes:6*z},{index:rn.prevPosition2DHigh,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:H,strideInBytes:6*z},{index:rn.prevPosition2DLow,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:Z,strideInBytes:6*z},{index:rn.nextPosition3DHigh,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:J,strideInBytes:6*z},{index:rn.nextPosition3DLow,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:K,strideInBytes:6*z},{index:rn.nextPosition2DHigh,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:J,strideInBytes:6*z},{index:rn.nextPosition2DLow,componentsPerAttribute:3,componentDatatype:ue.FLOAT,offsetInBytes:K,strideInBytes:6*z},{index:rn.texCoordExpandAndBatchIndex,componentsPerAttribute:4,componentDatatype:ue.FLOAT,vertexBuffer:e._texCoordExpandAndBatchIndexBuffer,offsetInBytes:te}];let we,Te,ve,Re;g===st.SCENE3D?(Te=e._positionBuffer,we="vertexBuffer",ve=Gu,Re="value"):g===st.SCENE2D||g===st.COLUMBUS_VIEW?(Te=Gu,we="value",ve=e._positionBuffer,Re="vertexBuffer"):(Te=F,we="vertexBuffer",ve=e._positionBuffer,Re="vertexBuffer"),he[0][we]=Te,he[1][we]=Te,he[2][Re]=ve,he[3][Re]=ve,he[4][we]=Te,he[5][we]=Te,he[6][Re]=ve,he[7][Re]=ve,he[8][we]=Te,he[9][we]=Te,he[10][Re]=ve,he[11][Re]=ve;const $e=new qn({context:t,attributes:he,indexBuffer:v});e._vertexArrays.push({va:$e,buckets:f[X]})}}}function cR(e,t){return t instanceof Kt?t.id:t}const Fa=[];function fR(e){const t=ee._uniformList[e.type],n=t.length;Fa.length=2*n;let o=0;for(let i=0;i<n;++i){const r=t[i];Fa[o]=r,Fa[o+1]=e._uniforms[r](),o+=2}return`${e.type}:${JSON.stringify(Fa,cR)}`}function hR(e){const t=e._mode,n=e._modelMatrix,o=e._polylineBuckets={},i=e._polylines,r=i.length;for(let a=0;a<r;++a){const s=i[a];if(s._actualPositions.length>1){s.update();const c=s.material;let f=o[c.type];l(f)||(f=o[c.type]=new ro(c,t,n)),f.addPolyline(s)}}}function lR(e,t){const n=t.mode;(e._mode!==n||!U.equals(e._modelMatrix,e.modelMatrix))&&(e._mode=n,e._modelMatrix=U.clone(e.modelMatrix),e._createVertexArray=!0)}function hh(e){if(e._polylinesRemoved){e._polylinesRemoved=!1;const t=[],n=[];let o=0,i;const r=e._polylines.length;for(let a=0;a<r;++a)i=e._polylines[a],i.isDestroyed||(i._index=o++,n.push(i),t.push(i));e._polylines=t,e._polylinesToUpdate=n}}function lh(e){const t=e._polylines,n=t.length;for(let o=0;o<n;++o)if(!t[o].isDestroyed){const i=t[o]._bucket;l(i)&&(i.shaderProgram=i.shaderProgram&&i.shaderProgram.destroy())}}function ep(e){const t=e._vertexArrays.length;for(let n=0;n<t;++n)e._vertexArrays[n].va.destroy();e._vertexArrays.length=0}Vn.prototype._updatePolyline=function(e,t){this._polylinesUpdated=!0,e._dirty||this._polylinesToUpdate.push(e),++this._propertiesChanged[t]};function tp(e){const t=e._polylines,n=t.length;for(let o=0;o<n;++o)t[o].isDestroyed||t[o]._destroy()}function zc(e,t,n){this.count=e,this.offset=t,this.bucket=n}function ro(e,t,n){this.polylines=[],this.lengthOfPositions=0,this.material=e,this.shaderProgram=void 0,this.mode=t,this.modelMatrix=n}ro.prototype.addPolyline=function(e){this.polylines.push(e),e._actualLength=this.getPolylinePositionsLength(e),this.lengthOfPositions+=e._actualLength,e._bucket=this};ro.prototype.updateShader=function(e,t,n){if(l(this.shaderProgram))return;const o=["DISTANCE_DISPLAY_CONDITION"];n&&o.push("VECTOR_TILE"),this.material.shaderSource.search(/in\s+float\s+v_polylineAngle;/g)!==-1&&o.push("POLYLINE_DASH"),xt.isInternetExplorer()||o.push("CLIP_POLYLINE");const i=new it({defines:o,sources:[`in vec4 v_pickColor;
`,this.material.shaderSource,XM]}),r=t.getVertexShaderCallback()(ZM),a=new it({defines:o,sources:[$M,r]});this.shaderProgram=Gn.fromCache({context:e,vertexShaderSource:a,fragmentShaderSource:i,attributeLocations:rn})};function np(e){return h.dot(h.UNIT_X,e._boundingVolume.center)<0||e._boundingVolume.intersectPlane(De.ORIGIN_ZX_PLANE)===bt.INTERSECTING}ro.prototype.getPolylinePositionsLength=function(e){let t;if(this.mode===st.SCENE3D||!np(e))return t=e._actualPositions.length,t*4-4;let n=0;const o=e._segments.lengths;t=o.length;for(let i=0;i<t;++i)n+=o[i]*4-4;return n};const vt=new h,An=new h,xn=new h,Es=new h,uR=new Q,dR=new V;ro.prototype.write=function(e,t,n,o,i,r,a,s){const c=this.mode,f=s.ellipsoid.maximumRadius*T.PI,d=this.polylines,u=d.length;for(let m=0;m<u;++m){const _=d[m],g=_.width,y=_.show&&g>0,E=_._index,A=this.getSegments(_,s),S=A.positions,O=A.lengths,M=S.length,R=_.getPickId(a).color;let N=0,F=0,z;for(let H=0;H<M;++H){H===0?_._loop?z=S[M-2]:(z=Es,h.subtract(S[0],S[1],z),h.add(S[0],z,z)):z=S[H-1],h.clone(z,An),h.clone(S[H],vt),H===M-1?_._loop?z=S[1]:(z=Es,h.subtract(S[M-1],S[M-2],z),h.add(S[M-1],z,z)):z=S[H+1],h.clone(z,xn);const Z=O[N];H===F+Z&&(F+=Z,++N);const J=H-F===0,K=H===F+O[N]-1;c===st.SCENE2D&&(An.z=0,vt.z=0,xn.z=0),(c===st.SCENE2D||c===st.MORPHING)&&(J||K)&&f-Math.abs(vt.x)<1&&((vt.x<0&&An.x>0||vt.x>0&&An.x<0)&&h.clone(vt,An),(vt.x<0&&xn.x>0||vt.x>0&&xn.x<0)&&h.clone(vt,xn));const te=J?2:0,he=K?2:4;for(let we=te;we<he;++we){at.writeElements(vt,e,n),at.writeElements(An,e,n+6),at.writeElements(xn,e,n+12);const Te=we-2<0?-1:1;t[i]=H/(M-1),t[i+1]=2*(we%2)-1,t[i+2]=Te,t[i+3]=E,n+=6*3,i+=4}}const G=uR;G.x=x.floatToByte(R.red),G.y=x.floatToByte(R.green),G.z=x.floatToByte(R.blue),G.w=x.floatToByte(R.alpha);const q=dR;q.x=g,q.y=y?1:0;const k=c===st.SCENE2D?_._boundingVolume2D:_._boundingVolumeWC,X=at.fromCartesian(k.center,Km),b=X.high,v=Q.fromElements(X.low.x,X.low.y,X.low.z,k.radius,Qm),C=Jm;C.x=0,C.y=Number.MAX_VALUE;const D=_.distanceDisplayCondition;l(D)&&(C.x=D.near,C.y=D.far),r.setBatchedAttribute(E,0,q),r.setBatchedAttribute(E,1,G),r.attributes.length>2&&(r.setBatchedAttribute(E,2,b),r.setBatchedAttribute(E,3,v),r.setBatchedAttribute(E,4,C))}};const mR=new h,pR=new h,_R=new h,ku=new h;ro.prototype.writeForMorph=function(e,t){const n=this.modelMatrix,o=this.polylines,i=o.length;for(let r=0;r<i;++r){const a=o[r],s=a._segments.positions,c=a._segments.lengths,f=s.length;let d=0,u=0;for(let m=0;m<f;++m){let _;m===0?a._loop?_=s[f-2]:(_=ku,h.subtract(s[0],s[1],_),h.add(s[0],_,_)):_=s[m-1],_=U.multiplyByPoint(n,_,pR);const g=U.multiplyByPoint(n,s[m],mR);let y;m===f-1?a._loop?y=s[1]:(y=ku,h.subtract(s[f-1],s[f-2],y),h.add(s[f-1],y,y)):y=s[m+1],y=U.multiplyByPoint(n,y,_R);const E=c[d];m===u+E&&(u+=E,++d);const A=m-u===0,S=m===u+c[d]-1,O=A?2:0,M=S?2:4;for(let R=O;R<M;++R)at.writeElements(g,e,t),at.writeElements(_,e,t+6),at.writeElements(y,e,t+12),t+=6*3}}};const gR=new Array(1);ro.prototype.updateIndices=function(e,t,n,o){let i=n.length-1,r=new zc(0,o,this);n[i].push(r);let a=0,s=e[e.length-1],c=0;s.length>0&&(c=s[s.length-1]+1);const f=this.polylines,d=f.length;for(let u=0;u<d;++u){const m=f[u];m._locatorBuckets=[];let _;if(this.mode===st.SCENE3D){_=gR;const y=m._actualPositions.length;if(y>0)_[0]=y;else continue}else _=m._segments.lengths;const g=_.length;if(g>0){let y=0;for(let E=0;E<g;++E){const A=_[E]-1;for(let S=0;S<A;++S)c+4>T.SIXTY_FOUR_KILOBYTES&&(m._locatorBuckets.push({locator:r,count:y}),y=0,t.push(4),s=[],e.push(s),c=0,r.count=a,a=0,o=0,r=new zc(0,0,this),n[++i]=[r]),s.push(c,c+2,c+1),s.push(c+1,c+2,c+3),y+=6,a+=6,o+=6,c+=4}m._locatorBuckets.push({locator:r,count:y}),c+4>T.SIXTY_FOUR_KILOBYTES&&(t.push(0),s=[],e.push(s),c=0,r.count=a,o=0,a=0,r=new zc(0,0,this),n[++i]=[r])}m._clean()}return r.count=a,o};ro.prototype.getPolylineStartIndex=function(e){const t=this.polylines;let n=0;const o=t.length;for(let i=0;i<o;++i){const r=t[i];if(r===e)break;n+=r._actualLength}return n};const Ei={positions:void 0,lengths:void 0},ju=new Array(1),yR=new h,bR=new le;ro.prototype.getSegments=function(e,t){let n=e._actualPositions;if(this.mode===st.SCENE3D)return ju[0]=n.length,Ei.positions=n,Ei.lengths=ju,Ei;np(e)&&(n=e._segments.positions);const o=t.ellipsoid,i=[],r=this.modelMatrix,a=n.length;let s,c=yR;for(let f=0;f<a;++f)s=n[f],c=U.multiplyByPoint(r,s,c),i.push(t.project(o.cartesianToCartographic(c,bR)));if(i.length>0){e._boundingVolume2D=ie.fromPoints(i,e._boundingVolume2D);const f=e._boundingVolume2D.center;e._boundingVolume2D.center=new h(f.z,f.x,f.y)}return Ei.positions=i,Ei.lengths=e._segments.lengths,Ei};let Vu;ro.prototype.writeUpdate=function(e,t,n,o){const i=this.mode,r=o.ellipsoid.maximumRadius*T.PI;let a=t._actualLength;if(a){e+=this.getPolylineStartIndex(t);let s=Vu;const c=6*a*3;!l(s)||s.length<c?s=Vu=new Float32Array(c):s.length>c&&(s=new Float32Array(s.buffer,0,c));const f=this.getSegments(t,o),d=f.positions,u=f.lengths;let m=0,_=0,g=0,y;a=d.length;for(let E=0;E<a;++E){E===0?t._loop?y=d[a-2]:(y=Es,h.subtract(d[0],d[1],y),h.add(d[0],y,y)):y=d[E-1],h.clone(y,An),h.clone(d[E],vt),E===a-1?t._loop?y=d[1]:(y=Es,h.subtract(d[a-1],d[a-2],y),h.add(d[a-1],y,y)):y=d[E+1],h.clone(y,xn);const A=u[_];E===g+A&&(g+=A,++_);const S=E-g===0,O=E===g+u[_]-1;i===st.SCENE2D&&(An.z=0,vt.z=0,xn.z=0),(i===st.SCENE2D||i===st.MORPHING)&&(S||O)&&r-Math.abs(vt.x)<1&&((vt.x<0&&An.x>0||vt.x>0&&An.x<0)&&h.clone(vt,An),(vt.x<0&&xn.x>0||vt.x>0&&xn.x<0)&&h.clone(vt,xn));const M=S?2:0,R=O?2:4;for(let N=M;N<R;++N)at.writeElements(vt,s,m),at.writeElements(An,s,m+6),at.writeElements(xn,s,m+12),m+=6*3}n.copyFromArrayView(s,6*3*Float32Array.BYTES_PER_ELEMENT*e)}};const ER=new No(1,0,0),wR=new No(0,1,0),vR=new No(0,0,-1),M4=e=>{const t=vR.clone().applyQuaternion(e).normalize(),n=wR.clone().applyQuaternion(e).normalize(),o=ER.clone().applyQuaternion(e).normalize();return{forward:t,up:n,right:o}},TR=({forward:e,right:t,up:n})=>new Jp().setFromRotationMatrix(new ai().makeBasis(t.clone().normalize(),n.clone().normalize(),e.clone().negate().normalize())),SR=new No(1,0,0),AR=new No(0,0,1),xR=new No(0,-1,0),op=new ai().makeBasis(SR,AR,xR),OR=op.clone().transpose(),ip=new ai,CR=(e=new ai)=>e.copy(op),MR=(e=new ai)=>e.copy(OR),RR=(e,t=e.clone())=>t.copy(e).transformDirection(MR(ip)),PR=(e,t=e.clone())=>t.copy(e).transformDirection(CR(ip)),rp=new ai,IR=new ai,Nc=(e,t,n=e.clone())=>{const o=n.copy(e).transformDirection($u(t,rp));return RR(o,n)},R4=(e,t,n=e.clone())=>{const o=PR(e,n),i=IR.copy($u(t,rp)).invert();return o.transformDirection(i).normalize()},P4=(e,t)=>{const n=Nc(e.forward,t),o=Nc(e.right,t);Nc(e.up,t);const i=o.clone().normalize(),r=new No().crossVectors(i,n).normalize(),a=new No().crossVectors(r,i).normalize();return TR({forward:a,right:i,up:r})},zi=e=>typeof e=="number"&&Number.isFinite(e),I4=e=>{if(e&&zi(e.fovy)&&e.fovy>0)return e.fovy;if(!(!e||!zi(e.fov)||e.fov<=0))return zi(e.aspectRatio)&&e.aspectRatio>1?Math.atan(Math.tan(e.fov*.5)/e.aspectRatio)*2:e.fov},z4=e=>{if(!(!e||!zi(e.fov)||e.fov<=0))return e.fov},zR=(e,t)=>{!zi(t)||t<=0||(e.fov=zi(e.aspectRatio)&&e.aspectRatio>1?Math.atan(Math.tan(t*.5)*e.aspectRatio)*2:t)};new ie;const NR=500,N4=(e,t,n,{durationMs:o=NR,easing:i=Ku.SINUSOIDAL_IN_OUT,onComplete:r,onCancel:a}={})=>{const s=e.camera;if(!s||e.isDestroyed())return()=>{};const c=s.heading,f=s.pitch,d=h.distance(t,s.position),u=b_(c,n.heading),m=n.pitch-f,_=n.range-d;if(Math.abs(u)<1e-6&&Math.abs(m)<1e-6&&Math.abs(_)<.001)return()=>{};let g=!1;const y=performance.now(),E=(M,R,N)=>{s.lookAt(t,new pf(M,R,N));try{s.lookAtTransform(U.IDENTITY)}catch{}},A=M=>{if(!e.isDestroyed()){e.preRender.removeEventListener(O);try{s.lookAtTransform(U.IDENTITY)}catch{}e.requestRender(),a==null||a()}},S=()=>{e.isDestroyed()||(E(n.heading,n.pitch,n.range),e.preRender.removeEventListener(O),e.requestRender(),r==null||r())},O=()=>{if(g||e.isDestroyed()){A();return}const M=performance.now()-y,R=o<=0?1:Math.min(M/o,1),N=T.clamp(i(R),0,1),F=c+u*N,z=f+m*N,G=d+_*N;E(F,z,G),e.requestRender(),R>=1&&S()};return e.preRender.addEventListener(O),e.requestRender(),()=>{g=!0,A()}},D4=(e,t,n={})=>{const o=e.camera;return o?(o.lookAtTransform(U.IDENTITY),o.flyTo({destination:t.position,orientation:{direction:t.direction,up:t.up},duration:n.duration,complete:n.onComplete,cancel:n.onCancel}),n.applyFov!==!1&&t.fov!==void 0&&o.frustum instanceof un&&zR(o.frustum,t.fov),e.requestRender(),!0):!1},DR=2,LR=5,FR=3,BR=1,UR=x.WHITE,GR=Ku.SINUSOIDAL_IN_OUT,ap="__carmaAxisVisualizerId",Hu=(e,t,{durationMs:n=200,easing:o=GR,onUpdate:i,onComplete:r,onCancel:a})=>{if(n<=0)return i(t),r==null||r(),()=>{};let s=!1;const c=performance.now();let f=0;const d=u=>{if(s)return;const m=u-c,_=Math.min(m/n,1),g=o(_),y=n_(e,t,g);if(i(y),_>=1){r==null||r();return}f=window.requestAnimationFrame(d)};return f=window.requestAnimationFrame(d),()=>{s||(s=!0,window.cancelAnimationFrame(f),a==null||a())}},Wu=(e,t)=>{const n=h.normalize(t,new h),o=Math.abs(h.dot(n,h.UNIT_Z))>.9?h.UNIT_X:h.UNIT_Z,i=h.normalize(h.cross(n,o,new h),new h),r=h.normalize(h.cross(i,n,new h),new h),a=U.clone(U.IDENTITY,new U);return U.setColumn(a,0,new Q(i.x,i.y,i.z,0),a),U.setColumn(a,1,new Q(r.x,r.y,r.z,0),a),U.setColumn(a,2,new Q(n.x,n.y,n.z,0),a),U.setColumn(a,3,new Q(e.x,e.y,e.z,1),a),a},qR=e=>{if(!e)return!1;try{return!e.isDestroyed()}catch{return!1}},kR=(e,t)=>{const n=e.primitives;for(let o=n.length-1;o>=0;o-=1){const i=n.get(o);if(i&&i[ap]===t)try{n.remove(i)}catch{}}},L4=(e,{origin:t,upVector:n,cameraPosition:o,lengthMultiplier:i=DR,dashPixelLength:r=LR,gapPixelLength:a=FR,color:s=UR,width:c=BR})=>{let f=t,d=h.normalize(n,new h),u=o,m=!1,_=!1,g=!0,y=1,E=null,A=null,S=null,O=null,M=null;const R=s,N=()=>{try{A==null||A()}catch{}},F=C=>{if(!E)return 1;const D=E.camera.frustum.fov||1;return C*Math.tan(D/2)*2/E.canvas.clientHeight},z=()=>u?h.distance(u,f)*i:1e5,G=()=>{if(!u||!E)return{dashMeters:1e3,gapMeters:500};const C=h.distance(u,f),D=F(C);return{dashMeters:r*D,gapMeters:a*D}},q=C=>{if(!S||!O)return;const D=O.uniforms.color;D?(D.red=R.red,D.green=R.green,D.blue=R.blue,D.alpha=C):O.uniforms.color=R.withAlpha(C),N()},k=()=>{if(!E)return;if(S)try{E.primitives.remove(S)}catch{}kR(E,e);const C=z(),{dashMeters:D,gapMeters:H}=G(),Z=C*2,J=D+H,K=Math.floor(Z/J);S=new Vn,S.modelMatrix=Wu(f,d),O=ee.fromType("Color",{color:R.withAlpha(y)});for(let te=0;te<K;te+=1){const he=-C+te*J,we=he+D;S.add({positions:[new h(0,0,he),new h(0,0,we)],width:c,material:O,show:g})}S[ap]=e,E.primitives.add(S)},X=()=>{if(!S||!E)return;S.modelMatrix=Wu(f,d);const C=z(),{dashMeters:D,gapMeters:H}=G(),Z=C*2,J=D+H,K=Math.floor(Z/J);if(S.length!==K){k();return}for(let te=0;te<K;te+=1){const he=S.get(te);if(!he)continue;const we=-C+te*J,Te=we+D;he.positions=[new h(0,0,we),new h(0,0,Te)],he.show=g}N()},b=()=>{M==null||M(),M=null},v={get id(){return e},get isAttached(){return m},get origin(){return f},get isVisible(){return g},attach:(C,D)=>{if(_)throw new Error("Cannot attach destroyed visualizer");m&&v.detach(),E=C,A=D,k(),m=!0,N()},detach:()=>{if(!(!m||!E)){if(b(),S&&qR(E))try{E.primitives.remove(S)}catch{}S=null,O=null,m=!1,N()}},destroy:()=>{_||(v.detach(),_=!0,E=null,A=null)},update:(C,D,H)=>{_||(f=C,d=h.normalize(D,new h),H&&(u=H),m&&X())},show:()=>{if(!_){if(b(),g=!0,y=1,S)for(let C=0;C<S.length;C+=1){const D=S.get(C);D&&(D.show=!0)}q(y)}},hide:()=>{if(!_){if(b(),g=!1,y=0,S)for(let C=0;C<S.length;C+=1){const D=S.get(C);D&&(D.show=!1)}q(y)}},fadeIn:C=>{if(!(_||!m)){if(b(),g=!0,S)for(let D=0;D<S.length;D+=1){const H=S.get(D);H&&(H.show=!0)}M=Hu(y,1,{durationMs:C,onUpdate:D=>{y=D,q(D)}})}},fadeOut:(C,D)=>{_||!m||(b(),M=Hu(y,0,{durationMs:C,onUpdate:H=>{y=H,q(H)},onComplete:()=>{if(g=!1,S)for(let H=0;H<S.length;H+=1){const Z=S.get(H);Z&&(Z.show=!1)}N(),D==null||D()}}))}};return v},It=new Array(16),zt=new Array(16),jR=new U,VR=new U,HR=new h,WR=1e-12,YR=(e,t=1,n=0,o=0)=>{const i=Math.max(t,o),r=Math.cos(n),a=Math.sin(n);return It[0]=i*r,It[1]=i*a,It[2]=0,It[3]=0,It[4]=-i*a,It[5]=i*r,It[6]=0,It[7]=0,It[8]=0,It[9]=0,It[10]=1,It[11]=0,It[12]=e.x,It[13]=e.y,It[14]=e.z,It[15]=1,U.fromArray(It,0,new U)},F4=(e,t,n,o,i=1,r=1,a=1,s=new U)=>(zt[0]=t.x*i,zt[1]=t.y*i,zt[2]=t.z*i,zt[3]=0,zt[4]=n.x*r,zt[5]=n.y*r,zt[6]=n.z*r,zt[7]=0,zt[8]=o.x*a,zt[9]=o.y*a,zt[10]=o.z*a,zt[11]=0,zt[12]=e.x,zt[13]=e.y,zt[14]=e.z,zt[15]=1,U.fromArray(zt,0,s)),B4=(e,t,n=new h)=>{const o=t*4;return h.fromElements(e[o],e[o+1],e[o+2],n)},U4=e=>h.magnitudeSquared(e)<=WR?null:h.normalize(e,new h),G4=(e,t,n=be.WGS84)=>{const o=Pe.eastNorthUpToFixedFrame(t,n,jR),i=U.inverseTransformation(o,VR),r=U.multiplyByPoint(i,e,HR);return{east:r.x,north:r.y,up:r.z}},Ni={COLOR:"color",CHROME_MIRROR:"chrome-mirror",FROSTED_GLASS:"frosted-glass"},sp=24,cp=x.WHITE.withAlpha(.65),$R=cp.alpha,fp=1e-6,uh=.001,XR=1e-8,Yu=1e-9,hp=ze.POSITION_ONLY,ZR=ze.POSITION_AND_ST,lp=qo.getDefaultRenderState(!0,!1),KR=e=>Math.max(Number.isFinite(e)?e:0,fp),QR=(e,t)=>{const n=Math.max(0,t-uh);return Vi(typeof e=="number"&&Number.isFinite(e)?e:0,0,n)},JR=(e,t)=>Vi(e/t,0,1-uh),up=e=>{const t=typeof e=="number"&&Number.isFinite(e)?e:Do;return Vi(t,0,Do)},dp=e=>Math.max(8,Math.floor(typeof e=="number"&&Number.isFinite(e)?e:sp)),e4=e=>typeof e=="number"&&Number.isFinite(e)?e:0,t4=(e,t)=>Vi(typeof e=="number"&&Number.isFinite(e)?e:t,0,1),n4=e=>e===Ni.CHROME_MIRROR||e===Ni.FROSTED_GLASS?e:Ni.COLOR,o4=(e,t)=>Math.abs(e-Do)<=t,i4=(e,t)=>{const n=Math.max(1,e);if(t<=Yu)return 1;if(o4(t,XR))return n;const o=t/Do*n,i=Math.round(o);return Math.abs(o-i)<=Yu?Math.max(1,i):Math.max(1,Math.ceil(o))},mp=(e,t)=>{const n=Math.max(1,e),o=Vi(t,0,Do),i=i4(n,o),r=i>=n;return{segments:n,pointCount:r?i:i+1,isFullCircle:r,stepRad:Do/n}},kr=(e,t=1)=>{const n=Math.max(t,0);return Array.from({length:e.pointCount},(o,i)=>{const r=e.stepRad*i;return new h(Math.cos(r)*n,Math.sin(r)*n,0)})},r4=(e,t)=>{const n=kr(e),o=kr(e,t).reverse();return new lf(n,[new lf(o)])},a4=({sampling:e,normalizedInnerRadius:t})=>{const n=kr(e);if(t<=0)return[h.ZERO,...n];const o=kr(e,t).reverse();return[...n,...o]},s4=({innerRadiusRatio:e=0,angleRad:t=Do,segments:n=sp,vertexFormat:o=hp})=>{const i=dp(n),r=up(t),a=Vi(Number.isFinite(e)?e:0,0,1-uh),s=mp(i,r);return s.isFullCircle?a>0?new mo({polygonHierarchy:r4(s,a),vertexFormat:o}):mo.fromPositions({positions:kr(s),vertexFormat:o}):mo.fromPositions({positions:a4({sampling:s,normalizedInnerRadius:a}),vertexFormat:o})},c4=`
...
void main()
{
    vec4 p = czm_computePosition();
    gl_Position = czm_modelViewProjectionRelativeToEye * p;
}`,Ba=e=>Number.isFinite(e)?e.toFixed(6):"0.0",dh=e=>`vec4(${Ba(e.red)}, ${Ba(e.green)}, ${Ba(e.blue)}, ${Ba(e.alpha)})`,h4=e=>`
in vec2 v_st;
...
}`,u4=(e,t)=>new qo({translucent:!0,closed:!1,renderState:lp,vertexShaderSource:c4,fragmentShaderSource:e===Ni.CHROME_MIRROR?h4(t):l4(t)}),d4=e=>`
void main()
{
    out_FragColor = ${dh(e)};
}`,m4=e=>new qo({translucent:e.alpha<1,closed:!1,renderState:lp,vertexShaderSource:f4,fragmentShaderSource:d4(e)}),p4=({id:e,geometry:t,color:n,opacity:o,materialPreset:i,modelMatrix:r})=>{const a=x.fromAlpha(n,o,new x);return i===Ni.COLOR?new rt({geometryInstances:new af({id:`${e}-fill`,geometry:t}),appearance:m4(a),allowPicking:!1,asynchronous:!0,releaseGeometryInstances:!0,show:!0,modelMatrix:r}):new rt({geometryInstances:new af({id:`${e}-fill`,geometry:t}),appearance:u4(i,a),allowPicking:!1,asynchronous:!0,releaseGeometryInstances:!0,show:!0,modelMatrix:r})},_4=e=>{const t=KR(e.radius),n=QR(e.innerRadius,t),o=dp(e.segments),i=up(e.angleRad),r=mp(o,i),a=e4(e.rotationRad),s=e.modelMatrix??U.IDENTITY,c=n4(e.materialPreset),f=e.color??cp,d=t4(e.opacity,f.alpha??$R),u=g4(h.ZERO,t,a);return{normalizedInnerRadius:JR(n,t),arcSampling:r,color:f,opacity:d,materialPreset:c,vertexFormat:c===Ni.COLOR?hp:ZR,modelMatrix:U.multiply(s,u,new U)}},g4=(e,t=1,n=0)=>YR(e,t,n,fp),y4=(e,t)=>{const n=_4(t),o=s4({innerRadiusRatio:n.normalizedInnerRadius,angleRad:t.angleRad,segments:n.arcSampling.segments,vertexFormat:n.vertexFormat});return p4({id:e,geometry:o,color:n.color,opacity:n.opacity,materialPreset:n.materialPreset,modelMatrix:n.modelMatrix})},b4=(e,t)=>y4(e,{...t,angleRad:Do,rotationRad:0}),q4=(e,t)=>b4(e,{...t,innerRadius:0});yf("[CESIUM|ELEVATION] Using core elevation helpers from @carma-mapping/engines/cesium/core.");export{L4 as $,Ge as A,ie as B,T as C,w as D,Ku as E,xe as F,af as G,pf as H,gt as I,M4 as J,un as K,zR as L,U as M,I4 as N,Be as O,rt as P,oe as Q,Se as R,R4 as S,Pe as T,P4 as U,F4 as V,B4 as W,Ni as X,o_ as Y,z4 as Z,b_ as _,h as a,hn as a$,D4 as a0,N4 as a1,_f as a2,yf as a3,st as a4,pn as a5,U4 as a6,G4 as a7,ze as a8,ds as a9,xt as aA,Pf as aB,Hc as aC,Me as aD,ah as aE,Kt as aF,jn as aG,Ft as aH,Ln as aI,qn as aJ,At as aK,Je as aL,ln as aM,qo as aN,it as aO,Ut as aP,X3 as aQ,fh as aR,Gn as aS,Kn as aT,Ci as aU,nn as aV,$M as aW,XM as aX,gr as aY,lf as aZ,Gr as a_,Ue as aa,ue as ab,tt as ac,qe as ad,We as ae,Eo as af,Kr as ag,ae as ah,je as ai,oi as aj,Jo as ak,to as al,Zt as am,gn as an,Ko as ao,De as ap,$t as aq,ke as ar,at as as,fn as at,Qr as au,ft as av,ji as aw,pr as ax,ot as ay,ge as az,x as b,en as b0,I as b1,Ie as b2,sd as b3,Oe as b4,oo as b5,nt as b6,_t as b7,Bi as b8,bt as b9,On as ba,Zo as bb,lo as bc,Bt as bd,ri as be,wo as bf,Cn as bg,v0 as bh,Xt as bi,_o as bj,Fe as bk,Gd as bl,R0 as bm,zr as bn,ml as bo,Nr as bp,ys as bq,no as br,Rt as bs,bi as bt,Tn as bu,C4 as bv,Sr as bw,na as bx,r_ as by,q4 as c,b4 as d,y4 as e,s4 as f,YR as g,l as h,V as i,Vn as j,ee as k,n_ as l,mo as m,B as n,Q as o,le as p,$r as q,p as r,St as s,Yi as t,mt as u,se as v,O4 as w,cs as x,Aw as y,be as z};
